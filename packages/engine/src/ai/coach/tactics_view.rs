...
use crate::ai::{types, TeamPhase, Vec2, PitchView, Role};
use crate::types::{
...
pub struct TacticsView {
    ...
    pub role_overrides: Option<[Option<Role>; 11]>,
    pub role_policies: [types::RolePolicy; 11],
}

impl Default for TacticsView {
    fn default() -> Self {
        Self {
            line_height: 0.5,
            width: 0.5,
            ...
            pass_risk_max: 0.5,
            role_overrides: None,
            role_policies: [types::RolePolicy {
                weights: types::Weights::default(),
                pass_risk_max: 0.5,
                theta_shot: 0.5,
                epsilon_base: 0.1,
                min_hold_ms: 300,
                press_triggers: types::PressTriggers {
                    on_backpass: true,
                    on_bad_touch: true,
