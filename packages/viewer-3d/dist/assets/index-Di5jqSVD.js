...
(async () => {
  ...
  const Aa = "169", Li = {
    ...
    DOLLY_PAN: 2,
    DOLLY_ROTATE: 3
  }, Uh = 0, nc = 1, Nh = 2, Cl = 1, Fh = 2, Mn = 3, Tn = 0, Dt = 1, Xt = 2, Vn = 0, Di = 1, ic = 2, sc = 3, rc = 4, Oh = 5, ni = 100, Bh = 101, kh = 102, zh = 103, Hh = 104, Vh = 200, Gh = 201, Wh = 202, Xh = 203, Uo = 204, No = 205, Yh = 206, qh = 207, Kh = 208, jh = 209, $h = 210, Zh = 211, Jh = 212, Qh = 213, eu = 214, Fo = 0, Oo = 1, Bo = 2, Oi = 3, ko = 4, zo = 5, Ho = 6, Vo = 7, Pl = 0, tu = 1, nu = 2, Gn = 0, iu = 1, su = 2, ru = 3, ou = 4, au = 5, cu = 6, lu = 7, oc = "attached", hu = "detached", Il = 300, Bi = 301, ki = 302, Go = 303, Wo = 304, Nr = 306, zi = 1e3, zn = 1001, Ar = 1002, Ct = 1003, Ll = 1004, us = 1005, zt = 1006, mr = 1007, En = 1008, An = 1009, Dl = 1010, Ul = 1011, vs = 1012, wa = 1013, ri = 1014, tn = 1015, As = 1016, Ra = 1017, Ca = 1018, Hi = 1020, Nl = 35902, Fl = 1021, Ol = 1022, qt = 1023, Bl = 1024, kl = 1025, Ui = 1026, Vi = 1027, Pa = 1028, Ia = 1029, zl = 1030, La = 1031, Da = 1033, gr = 33776, _r = 33777, xr = 33778, vr = 33779, Xo = 35840, Yo = 35841, qo = 35842, Ko = 35843, jo = 36196, $o = 37492, Zo = 37496, Jo = 37808, Qo = 37809, ea = 37810, ta = 37811, na = 37812, ia = 37813, sa = 37814, ra = 37815, oa = 37816, aa = 37817, ca = 37818, la = 37819, ha = 37820, ua = 37821, yr = 36492, da = 36494, fa = 36495, Hl = 36283, pa = 36284, ma = 36285, ga = 36286, Vl = 2200, uu = 2201, du = 2202, ys = 2300, Ms = 2301, Xr = 2302, Ri = 2400, Ci = 2401, wr = 2402, Ua = 2500, fu = 2501, pu = 0, Gl = 1, _a = 2, mu = 3200, gu = 3201, Wl = 0, _u = 1, kn = "", wt = "srgb", St = "srgb-linear", Na = "display-p3", Fr = "display-p3-linear", Rr = "linear", rt = "srgb", Cr = "rec709", Pr = "p3", ci = 7680, ac = 519, xu = 512, vu = 513, yu = 514, Xl = 515, Mu = 516, Su = 517, Eu = 518, bu = 519, xa = 35044, cc = "300 es", bn = 2e3, Ir = 2001;
  class Xn {
  ...
  const uc = new De().set(0.8224621, 0.177538, 0, 0.0331941, 0.9668058, 0, 0.0170827, 0.0723974, 0.9105199), dc = new De().set(1.2249401, -0.2249404, 0, -0.0420569, 1.0420571, 0, -0.0196376, -0.0786361, 1.0982735), Ji = {
    [St]: {
      transfer: Rr,
      primaries: Cr,
    ...
    [Fr]: {
      ...
      toReference: (s) => s.applyMatrix3(dc),
      fromReference: (s) => s.applyMatrix3(uc)
    },
    [Na]: {
      transfer: rt,
      primaries: Pr,
      ...
      toReference: (s) => s.convertSRGBToLinear().applyMatrix3(dc),
      fromReference: (s) => s.applyMatrix3(uc).convertLinearToSRGB()
    }
  }, Xu = /* @__PURE__ */ new Set([
    St,
    Fr
  ...
  class ql {
    constructor(e = null) {
      this.isSource = true, Object.defineProperty(this, "id", {
        value: qu++
      }), this.uuid = sn(), this.data = e, this.dataReady = true, this.version = 0;
    }
    set needsUpdate(e) {
      e === true && this.version++;
    }
  ...
  class ju extends Xn {
    ...
    copy(e) {
      ...
      return this.texture.source = new ql(t), this.depthBuffer = e.depthBuffer, this.stencilBuffer = e.stencilBuffer, this.resolveDepthBuffer = e.resolveDepthBuffer, this.resolveStencilBuffer = e.resolveStencilBuffer, e.depthTexture !== null && (this.depthTexture = e.depthTexture.clone()), this.samples = e.samples, this;
    }
    dispose() {
      this.dispatchEvent({
        type: "dispose"
  ...
  class Kl extends pt {
    constructor(e = null, t = 1, n = 1, i = 1) {
      super(null), this.isDataArrayTexture = true, this.image = {
        ...
        height: n,
        depth: i
      }, this.magFilter = Ct, this.minFilter = Ct, this.wrapR = zn, this.generateMipmaps = false, this.flipY = false, this.unpackAlignment = 1, this.layerUpdates = /* @__PURE__ */ new Set();
    }
    addLayerUpdate(e) {
  ...
  class $u extends pt {
    constructor(e = null, t = 1, n = 1, i = 1) {
      super(null), this.isData3DTexture = true, this.image = {
        ...
        height: n,
        depth: i
      }, this.magFilter = Ct, this.minFilter = Ct, this.wrapR = zn, this.generateMipmaps = false, this.flipY = false, this.unpackAlignment = 1;
    }
  }
  class Ut {
    constructor(e = 0, t = 0, n = 0, i = 1) {
  ...
  class ln {
    ...
    intersectsTriangle(e) {
      ...
      this.getCenter(Qi), Us.subVectors(this.max, Qi), hi.subVectors(e.a, Qi), ui.subVectors(e.b, Qi), di.subVectors(e.c, Qi), Cn.subVectors(ui, hi), Pn.subVectors(di, ui), qn.subVectors(hi, di);
      let t = [
        0,
        -Cn.z,
        Cn.y,
      ...
      return !$r(t, hi, ui, di, Us) || (t = [
        ...
        0,
        1
      ], !$r(t, hi, ui, di, Us)) ? false : (Ns.crossVectors(Cn, Pn), t = [
        Ns.x,
        Ns.y,
        Ns.z
      ], $r(t, hi, ui, di, Us));
  ...
  const pn = [
    ...
    new R(),
    new R()
  ], jt = new R(), Ds = new ln(), hi = new R(), ui = new R(), di = new R(), Cn = new R(), Pn = new R(), qn = new R(), Qi = new R(), Us = new R(), Ns = new R(), Kn = new R();
  ...
  const Zu = new ln(), es = new R(), Zr = new R();
  class hn {
  ...
  const mn = new R(), Jr = new R(), Fs = new R(), In = new R(), Qr = new R(), Os = new R(), eo = new R();
  class ws {
    ...
    distanceSqToSegment(e, t, n, i) {
      Jr.copy(e).add(t).multiplyScalar(0.5), Fs.copy(t).sub(e).normalize(), In.copy(this.origin).sub(Jr);
      const r = e.distanceTo(t) * 0.5, o = -this.direction.dot(Fs), a = In.dot(this.direction), c = -In.dot(Fs), l = In.lengthSq(), h = Math.abs(1 - o * o);
      let u, d, f, g;
      ...
      return n && n.copy(this.origin).addScaledVector(this.direction, u), i && i.copy(Jr).addScaledVector(Fs, d), f;
    }
    intersectSphere(e, t) {
    ...
    intersectTriangle(e, t, n, i, r) {
      Qr.subVectors(t, e), Os.subVectors(n, e), eo.crossVectors(Qr, Os);
      ...
      const c = a * this.direction.dot(Os.crossVectors(In, Os));
      if (c < 0) return null;
      const l = a * this.direction.dot(Qr.cross(In));
  ...
  class Ce {
    ...
    lookAt(e, t, n) {
      ...
      return Bt.subVectors(e, t), Bt.lengthSq() === 0 && (Bt.z = 1), Bt.normalize(), Ln.crossVectors(n, Bt), Ln.lengthSq() === 0 && (Math.abs(n.z) === 1 ? Bt.x += 1e-4 : Bt.z += 1e-4, Bt.normalize(), Ln.crossVectors(n, Bt)), Ln.normalize(), Bs.crossVectors(Bt, Ln), i[0] = Ln.x, i[4] = Bs.x, i[8] = Bt.x, i[1] = Ln.y, i[5] = Bs.y, i[9] = Bt.y, i[2] = Ln.z, i[6] = Bs.z, i[10] = Bt.z, this;
    }
    multiply(e) {
      return this.multiplyMatrices(this, e);
    }
    ...
    multiplyMatrices(e, t) {
      const n = e.elements, i = t.elements, r = this.elements, o = n[0], a = n[4], c = n[8], l = n[12], h = n[1], u = n[5], d = n[9], f = n[13], g = n[2], _ = n[6], m = n[10], p = n[14], E = n[3], M = n[7], b = n[11], I = n[15], A = i[0], w = i[4], U = i[8], K = i[12], x = i[1], S = i[5], k = i[9], B = i[13], H = i[2], j = i[6], z = i[10], Q = i[14], G = i[3], ae = i[7], ce = i[11], _e = i[15];
      return r[0] = o * A + a * x + c * H + l * G, r[4] = o * w + a * S + c * j + l * ae, r[8] = o * U + a * k + c * z + l * ce, r[12] = o * K + a * B + c * Q + l * _e, r[1] = h * A + u * x + d * H + f * G, r[5] = h * w + u * S + d * j + f * ae, r[9] = h * U + u * k + d * z + f * ce, r[13] = h * K + u * B + d * Q + f * _e, r[2] = g * A + _ * x + m * H + p * G, r[6] = g * w + _ * S + m * j + p * ae, r[10] = g * U + _ * k + m * z + p * ce, r[14] = g * K + _ * B + m * Q + p * _e, r[3] = E * A + M * x + b * H + I * G, r[7] = E * w + M * S + b * j + I * ae, r[11] = E * U + M * k + b * z + I * ce, r[15] = E * K + M * B + b * Q + I * _e, this;
    }
    multiplyScalar(e) {
      const t = this.elements;
    ...
    makePerspective(e, t, n, i, r, o, a = bn) {
      const c = this.elements, l = 2 * r / (t - e), h = 2 * r / (n - i), u = (t + e) / (t - e), d = (n + i) / (n - i);
      let f, g;
      if (a === bn) f = -(o + r) / (o - r), g = -2 * o * r / (o - r);
      else if (a === Ir) f = -o / (o - r), g = -o * r / (o - r);
    ...
    makeOrthographic(e, t, n, i, r, o, a = bn) {
      const c = this.elements, l = 1 / (t - e), h = 1 / (n - i), u = 1 / (o - r), d = (t + e) * l, f = (n + i) * h;
      let g, _;
      if (a === bn) g = (o + r) * u, _ = -2 * u;
      else if (a === Ir) g = r * u, _ = -1 * u;
  ...
  const fi = new R(), $t = new Ce(), Ju = new R(0, 0, 0), Qu = new R(1, 1, 1), Ln = new R(), Bs = new R(), Bt = new R(), pc = new Ce(), mc = new Ut();
  class cn {
  ...
  let ed = 0;
  const gc = new R(), pi = new Ut(), gn = new Ce(), ks = new R(), ts = new R(), td = new R(), nd = new Ut(), _c = new R(1, 0, 0), xc = new R(0, 1, 0), vc = new R(0, 0, 1), yc = {
    type: "added"
  }, id = {
    type: "removed"
  }, mi = {
  ...
  class ot extends Xn {
    constructor() {
      super(), this.isObject3D = true, Object.defineProperty(this, "id", {
        value: ed++
      }), this.uuid = sn(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = ot.DEFAULT_UP.clone();
      const e = new R(), t = new cn(), n = new Ut(), i = new R(1, 1, 1);
      function r() {
    ...
    lookAt(e, t, n) {
      ...
      const i = this.parent;
      this.updateWorldMatrix(true, false), ts.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? gn.lookAt(ts, ks, this.up) : gn.lookAt(ks, ts, this.up), this.quaternion.setFromRotationMatrix(gn), i && (gn.extractRotation(i.matrixWorld), pi.setFromRotationMatrix(gn), this.quaternion.premultiply(pi.invert()));
    }
    add(e) {
  ...
  const Zt = new R(), _n = new R(), no = new R(), xn = new R(), gi = new R(), _i = new R(), Mc = new R(), io = new R(), so = new R(), ro = new R(), oo = new Ye(), ao = new Ye(), co = new Ye();
  class Yt {
    ...
    static getBarycoord(e, t, n, i, r) {
      Zt.subVectors(i, t), _n.subVectors(n, t), no.subVectors(e, t);
      const o = Zt.dot(Zt), a = Zt.dot(_n), c = Zt.dot(no), l = _n.dot(_n), h = _n.dot(no), u = o * l - a * a;
      if (u === 0) return r.set(0, 0, 0), null;
      const d = 1 / u, f = (l * c - a * h) * d, g = (o * h - a * c) * d;
      return r.set(1 - f - g, g, f);
    }
    static containsPoint(e, t, n, i) {
      return this.getBarycoord(e, t, n, i, xn) === null ? false : xn.x >= 0 && xn.y >= 0 && xn.x + xn.y <= 1;
    }
    static getInterpolation(e, t, n, i, r, o, a, c) {
      return this.getBarycoord(e, t, n, i, xn) === null ? (c.x = 0, c.y = 0, "z" in c && (c.z = 0), "w" in c && (c.w = 0), null) : (c.setScalar(0), c.addScaledVector(r, xn.x), c.addScaledVector(o, xn.y), c.addScaledVector(a, xn.z), c);
    }
    ...
    static isFrontFacing(e, t, n, i) {
      return Zt.subVectors(n, t), _n.subVectors(e, t), Zt.cross(_n).dot(i) < 0;
    }
    set(e, t, n) {
    ...
    getArea() {
      return Zt.subVectors(this.c, this.b), _n.subVectors(this.a, this.b), Zt.cross(_n).length() * 0.5;
    }
    getMidpoint(e) {
    ...
    getInterpolation(e, t, n, i, r) {
      return Yt.getInterpolation(e, this.a, this.b, this.c, t, n, i, r);
    }
    containsPoint(e) {
  ...
  class Se {
    ...
    lerpHSL(e, t) {
      this.getHSL(Dn), e.getHSL(zs);
      const n = gs(Dn.h, zs.h, t), i = gs(Dn.s, zs.s, t), r = gs(Dn.l, zs.l, t);
  ...
  class rn extends Xn {
    constructor() {
      super(), this.isMaterial = true, Object.defineProperty(this, "id", {
        value: sd++
      }), this.uuid = sn(), this.name = "", this.type = "Material", this.blending = Di, this.side = Tn, this.vertexColors = false, this.opacity = 1, this.transparent = false, this.alphaHash = false, this.blendSrc = Uo, this.blendDst = No, this.blendEquation = ni, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new Se(0, 0, 0), this.blendAlpha = 0, this.depthFunc = Oi, this.depthTest = true, this.depthWrite = true, this.stencilWriteMask = 255, this.stencilFunc = ac, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = ci, this.stencilZFail = ci, this.stencilZPass = ci, this.stencilWrite = false, this.clippingPlanes = null, this.clipIntersection = false, this.clipShadows = false, this.shadowSide = null, this.colorWrite = true, this.precision = null, this.polygonOffset = false, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = false, this.alphaToCoverage = false, this.premultipliedAlpha = false, this.forceSinglePass = false, this.visible = true, this.toneMapped = true, this.userData = {}, this.version = 0, this._alphaTest = 0;
    }
    get alphaTest() {
  ...
  const dt = new R(), Hs = new me();
  class vt {
    constructor(e, t, n = false) {
      if (Array.isArray(e)) throw new TypeError("THREE.BufferAttribute: array should be a Typed Array.");
      this.isBufferAttribute = true, this.name = "", this.array = e, this.itemSize = t, this.count = e !== void 0 ? e.length / t : 0, this.normalized = n, this.usage = xa, this.updateRanges = [], this.gpuType = tn, this.version = 0;
    }
    onUploadCallback() {
    }
    set needsUpdate(e) {
    ...
    applyMatrix3(e) {
      if (this.itemSize === 2) for (let t = 0, n = this.count; t < n; t++) Hs.fromBufferAttribute(this, t), Hs.applyMatrix3(e), this.setXY(t, Hs.x, Hs.y);
  ...
  let rd = 0;
  const Gt = new Ce(), ho = new ot(), xi = new R(), kt = new ln(), ns = new ln(), xt = new R();
  class _t extends Xn {
    constructor() {
    ...
    setIndex(e) {
      return Array.isArray(e) ? this.index = new (Yl(e) ? Jl : Zl)(e, 1) : this.index = e, this;
    }
    getAttribute(e) {
    ...
    computeBoundingSphere() {
      ...
      if (e) {
        ...
        if (kt.setFromBufferAttribute(e), t) for (let r = 0, o = t.length; r < o; r++) {
          const a = t[r];
          ns.setFromBufferAttribute(a), this.morphTargetsRelative ? (xt.addVectors(kt.min, ns.min), kt.expandByPoint(xt), xt.addVectors(kt.max, ns.max), kt.expandByPoint(xt)) : (kt.expandByPoint(ns.min), kt.expandByPoint(ns.max));
        }
        kt.getCenter(n);
        let i = 0;
    ...
    computeTangents() {
      ...
      const l = new R(), h = new R(), u = new R(), d = new me(), f = new me(), g = new me(), _ = new R(), m = new R();
      function p(U, K, x) {
      ...
      function w(U) {
        ...
        const K = a[U];
        M.copy(K), M.sub(I.multiplyScalar(I.dot(K))).normalize(), b.crossVectors(A, K);
  ...
  const Sc = new Ce(), jn = new ws(), Vs = new hn(), Ec = new R(), Gs = new R(), Ws = new R(), Xs = new R(), uo = new R(), Ys = new R(), bc = new R(), qs = new R();
  class tt extends ot {
    constructor(e = new _t(), t = new Ht()) {
    ...
    getVertexPosition(e, t) {
      ...
      if (r && a) {
        ...
        for (let c = 0, l = r.length; c < l; c++) {
          const h = a[c], u = r[c];
          h !== 0 && (uo.fromBufferAttribute(u, e), o ? Ys.addScaledVector(uo, h) : Ys.addScaledVector(uo.sub(t), h));
        }
        t.add(Ys);
      }
      return t;
    ...
    raycast(e, t) {
      ...
      i !== void 0 && (n.boundingSphere === null && n.computeBoundingSphere(), Vs.copy(n.boundingSphere), Vs.applyMatrix4(r), jn.copy(e.ray).recast(e.near), !(Vs.containsPoint(jn.origin) === false && (jn.intersectSphere(Vs, Ec) === null || jn.origin.distanceToSquared(Ec) > (e.far - e.near) ** 2)) && (Sc.copy(r).invert(), jn.copy(e.ray).applyMatrix4(Sc), !(n.boundingBox !== null && jn.intersectsBox(n.boundingBox) === false) && this._computeIntersections(e, t, jn)));
    }
    _computeIntersections(e, t, n) {
      ...
      if (a !== null) if (Array.isArray(o)) for (let g = 0, _ = d.length; g < _; g++) {
        ...
        for (let b = E, I = M; b < I; b += 3) {
          ...
          i = Ks(this, p, e, n, l, h, u, A, w, U), i && (i.faceIndex = Math.floor(b / 3), i.face.materialIndex = m.materialIndex, t.push(i));
        }
      }
      else {
        ...
        for (let m = g, p = _; m < p; m += 3) {
          ...
          i = Ks(this, o, e, n, l, h, u, E, M, b), i && (i.faceIndex = Math.floor(m / 3), t.push(i));
        }
      }
  ...
  function od(s, e, t, n, i, r, o, a) {
    let c;
    if (e.side === Dt ? c = n.intersectTriangle(o, r, i, true, a) : c = n.intersectTriangle(i, r, o, e.side === Tn, a), c === null) return null;
  ...
  function Ks(s, e, t, n, i, r, o, a, c, l) {
    s.getVertexPosition(a, Gs), s.getVertexPosition(c, Ws), s.getVertexPosition(l, Xs);
    const h = od(s, e, t, n, Gs, Ws, Xs, bc);
    if (h) {
      const u = new R();
      Yt.getBarycoord(bc, Gs, Ws, Xs, u), i && (h.uv = Yt.getInterpolatedAttribute(i, a, c, l, u, new me())), r && (h.uv1 = Yt.getInterpolatedAttribute(r, a, c, l, u, new me())), o && (h.normal = Yt.getInterpolatedAttribute(o, a, c, l, u, new R()), h.normal.dot(n.direction) > 0 && h.normal.multiplyScalar(-1));
      const d = {
        a,
        b: c,
        c: l,
      ...
      Yt.getNormal(Gs, Ws, Xs, d.normal), h.face = d, h.barycoord = u;
    }
    return h;
  }
  class Rs extends _t {
    constructor(e = 1, t = 1, n = 1, i = 1, r = 1, o = 1) {
      ...
      function g(_, m, p, E, M, b, I, A, w, U, K) {
        ...
        for (let ce = 0; ce < z; ce++) {
          ...
          for (let We = 0; We < j; We++) {
            const $e = We * x - k;
            ae[_] = $e * E, ae[m] = _e * M, ae[p] = H, l.push(ae.x, ae.y, ae.z), ae[_] = 0, ae[m] = 0, ae[p] = A > 0 ? 1 : -1, h.push(ae.x, ae.y, ae.z), u.push(We / w), u.push(1 - ce / U), Q += 1;
          }
        }
        for (let ce = 0; ce < U; ce++) for (let _e = 0; _e < w; _e++) {
          const We = d + _e + j * ce, $e = d + _e + j * (ce + 1), W = d + (_e + 1) + j * (ce + 1), Z = d + (_e + 1) + j * ce;
  ...
  class Wn extends rn {
    constructor(e) {
      super(), this.isShaderMaterial = true, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = ld, this.fragmentShader = hd, this.linewidth = 1, this.wireframe = false, this.wireframeLinewidth = 1, this.fog = false, this.lights = false, this.clipping = false, this.forceSinglePass = true, this.extensions = {
  ...
  class eh extends ot {
    constructor() {
      super(), this.isCamera = true, this.type = "Camera", this.matrixWorldInverse = new Ce(), this.projectionMatrix = new Ce(), this.projectionMatrixInverse = new Ce(), this.coordinateSystem = bn;
    }
    copy(e, t) {
  ...
  const Un = new R(), Tc = new me(), Ac = new me();
  class Rt extends eh {
  ...
  class ud extends ot {
    ...
    updateCoordinateSystem() {
      ...
      if (e === bn) n.up.set(0, 1, 0), n.lookAt(1, 0, 0), i.up.set(0, 1, 0), i.lookAt(-1, 0, 0), r.up.set(0, 0, -1), r.lookAt(0, 1, 0), o.up.set(0, 0, 1), o.lookAt(0, -1, 0), a.up.set(0, 1, 0), a.lookAt(0, 0, 1), c.up.set(0, 1, 0), c.lookAt(0, 0, -1);
      else if (e === Ir) n.up.set(0, -1, 0), n.lookAt(-1, 0, 0), i.up.set(0, -1, 0), i.lookAt(1, 0, 0), r.up.set(0, 0, 1), r.lookAt(0, 1, 0), o.up.set(0, 0, -1), o.lookAt(0, -1, 0), a.up.set(0, -1, 0), a.lookAt(0, 0, 1), c.up.set(0, -1, 0), c.lookAt(0, 0, -1);
  ...
  class dd extends oi {
    constructor(e = 1, t = {}) {
      ...
      this.texture = new th(i, t.mapping, t.wrapS, t.wrapT, t.magFilter, t.minFilter, t.format, t.type, t.anisotropy, t.colorSpace), this.texture.isRenderTargetTexture = true, this.texture.generateMipmaps = t.generateMipmaps !== void 0 ? t.generateMipmaps : false, this.texture.minFilter = t.minFilter !== void 0 ? t.minFilter : zt;
    }
    fromEquirectangularTexture(e, t) {
      ...
      return t.minFilter === En && (t.minFilter = zt), new ud(1, 10, this).update(e, o), t.minFilter = a, o.geometry.dispose(), o.material.dispose(), this;
    }
    clear(e, t, n, i) {
  ...
  class Oa {
    ...
    setFromProjectionMatrix(e, t = bn) {
      ...
      if (n[0].setComponents(c - r, d - l, m - f, b - p).normalize(), n[1].setComponents(c + r, d + l, m + f, b + p).normalize(), n[2].setComponents(c + o, d + h, m + g, b + E).normalize(), n[3].setComponents(c - o, d - h, m - g, b - E).normalize(), n[4].setComponents(c - a, d - u, m - _, b - M).normalize(), t === bn) n[5].setComponents(c + a, d + u, m + _, b + M).normalize();
      else if (t === Ir) n[5].setComponents(a, u, _, M).normalize();
    ...
    intersectsBox(e) {
      ...
      for (let n = 0; n < 6; n++) {
        const i = t[n];
        if (js.x = i.normal.x > 0 ? e.max.x : e.min.x, js.y = i.normal.y > 0 ? e.max.y : e.min.y, js.z = i.normal.z > 0 ? e.max.z : e.min.z, i.distanceToPoint(js) < 0) return false;
      }
      return true;
    }
    containsPoint(e) {
...
void main() {
    ...
    map_particle_fragment: Tf,
    map_particle_pars_fragment: Af,
    metalnessmap_fragment: wf,
    metalnessmap_pars_fragment: Rf,
  ...
  function Zp(s, e, t, n, i, r, o) {
    ...
    function m(E, M) {
      const b = g(M);
      b && (b.isCubeTexture || b.mapping === Nr) ? (h === void 0 && (h = new tt(new Rs(1, 1, 1), new Wn({
        name: "BackgroundCubeMaterial",
        uniforms: Wi(an.backgroundCube.uniforms),
      ...
      }), i.update(h)), Zn.copy(M.backgroundRotation), Zn.x *= -1, Zn.y *= -1, Zn.z *= -1, b.isCubeTexture && b.isRenderTargetTexture === false && (Zn.y *= -1, Zn.z *= -1), h.material.uniforms.envMap.value = b, h.material.uniforms.flipEnvMap.value = b.isCubeTexture && b.isRenderTargetTexture === false ? -1 : 1, h.material.uniforms.backgroundBlurriness.value = M.backgroundBlurriness, h.material.uniforms.backgroundIntensity.value = M.backgroundIntensity, h.material.uniforms.backgroundRotation.value.setFromMatrix4($p.makeRotationFromEuler(Zn)), h.material.toneMapped = Ge.getTransfer(b.colorSpace) !== rt, (u !== b || d !== b.version || f !== s.toneMapping) && (h.material.needsUpdate = true, u = b, d = b.version, f = s.toneMapping), h.layers.enableAll(), E.unshift(h, h.geometry, h.material, 0, 0, null)) : b && b.isTexture && (l === void 0 && (l = new tt(new si(2, 2), new Wn({
        name: "BackgroundMaterial",
        uniforms: Wi(an.background.uniforms),
    ...
    function p(E, M) {
      E.getRGB($s, Ql(s)), n.buffers.color.setClear($s.r, $s.g, $s.b, M, o);
    }
    return {
  ...
  function Jp(s, e) {
    ...
    function f(x, S, k, B) {
      ...
      for (const G in Q) if (Q[G].location >= 0) {
        const ce = H[G];
        let _e = j[G];
        if (_e === void 0 && (G === "instanceMatrix" && x.instanceMatrix && (_e = x.instanceMatrix), G === "instanceColor" && x.instanceColor && (_e = x.instanceColor)), ce === void 0 || ce.attribute !== _e || _e && ce.data !== _e.data) return true;
        z++;
      }
    ...
    function g(x, S, k, B) {
      ...
      for (const G in Q) if (Q[G].location >= 0) {
        ...
        const _e = {};
        _e.attribute = ce, ce && ce.data && (_e.data = ce.data), H[G] = _e, z++;
      }
      ...
      for (const Q in j) {
        ...
        if (G.location >= 0) {
          ...
          if (ae === void 0 && (Q === "instanceMatrix" && x.instanceMatrix && (ae = x.instanceMatrix), Q === "instanceColor" && x.instanceColor && (ae = x.instanceColor)), ae !== void 0) {
            const ce = ae.normalized, _e = ae.itemSize, We = e.get(ae);
            if (We === void 0) continue;
            const $e = We.buffer, W = We.type, Z = We.bytesPerElement, pe = W === s.INT || W === s.UNSIGNED_INT || ae.gpuType === wa;
            if (ae.isInterleavedBufferAttribute) {
              ...
              for (let Oe = 0; Oe < G.locationSize; Oe++) M(G.location + Oe, _e / G.locationSize, W, ce, Pe * Z, (Ee + _e / G.locationSize * Oe) * Z, pe);
            } else {
              ...
              s.bindBuffer(s.ARRAY_BUFFER, $e);
              for (let le = 0; le < G.locationSize; le++) M(G.location + le, _e / G.locationSize, W, ce, _e * Z, _e / G.locationSize * le * Z, pe);
            }
          } else if (z !== void 0) {
            const ce = z[Q];
  ...
  function em(s, e, t, n) {
    ...
    function o(w) {
      return !(w !== qt && n.convert(w) !== s.getParameter(s.IMPLEMENTATION_COLOR_READ_FORMAT));
    }
    function a(w) {
      const U = w === As && (e.has("EXT_color_buffer_half_float") || e.has("EXT_color_buffer_float"));
      return !(w !== An && n.convert(w) !== s.getParameter(s.IMPLEMENTATION_COLOR_READ_TYPE) && w !== tn && !U);
    }
    function c(w) {
      if (w === "highp") {
  ...
  const Pi = 4, wc = [
    ...
    0.526,
    0.582
  ], ii = 20, po = new Ba(), Rc = new Se();
  let mo = null, go = 0, _o = 0, xo = false;
  const ei = (1 + Math.sqrt(5)) / 2, Mi = 1 / ei, Cc = [
    new R(-ei, Mi, 0),
    new R(ei, Mi, 0),
    new R(-Mi, 0, ei),
    new R(Mi, 0, ei),
  ...
  class Pc {
    ...
    _cleanup(e) {
      this._renderer.setRenderTarget(mo, go, _o), this._renderer.xr.enabled = xo, e.scissorTest = false, Zs(e, 0, 0, e.width, e.height);
    }
    _fromTexture(e, t) {
    ...
    _sceneToCubeUV(e, t, n, i) {
      ...
      for (let p = 0; p < 6; p++) {
        ...
        Zs(i, E * M, p > 2 ? M : 0, M, M), h.setRenderTarget(i), _ && h.render(g, a), h.render(e, a);
      }
    ...
    _textureToCubeUV(e, t) {
      ...
      Zs(t, 0, 0, 3 * c, 2 * c), n.setRenderTarget(t), n.render(o, po);
    }
    _applyPMREM(e) {
    ...
    _halfBlur(e, t, n, i, r, o, a) {
      ...
      const h = 3, u = new tt(this._lodPlanes[i], l), d = l.uniforms, f = this._sizeLods[n] - 1, g = isFinite(r) ? Math.PI / (2 * f) : 2 * Math.PI / (2 * ii - 1), _ = r / g, m = isFinite(r) ? 1 + Math.floor(h * _) : ii;
      ...
      const b = this._sizeLods[i], I = 3 * b * (i > M - Pi ? i - M + Pi : 0), A = 4 * (this._cubeSize - b);
      Zs(t, I, A, 3 * b, 2 * b), c.setRenderTarget(t), c.render(u, po);
    }
  }
  function im(s) {
    const e = [], t = [], n = [];
    ...
    for (let o = 0; o < r; o++) {
      ...
      const I = new _t();
      I.setAttribute("position", new vt(E, _)), I.setAttribute("uv", new vt(M, m)), I.setAttribute("faceIndex", new vt(b, p)), e.push(I), i > Pi && i--;
    }
    return {
      lodPlanes: e,
      sizeLods: t,
  ...
  function hm(s, e, t) {
    ...
    function r(o, a, c) {
      ...
      if (d === void 0 || d.count !== u) {
        ...
        const A = new Float32Array(b * I * 4 * u), w = new Kl(A, b, I, u);
  ...
  class ih extends pt {
    constructor(e, t, n, i, r, o, a, c, l, h = Ui) {
      ...
      n === void 0 && h === Ui && (n = ri), n === void 0 && h === Vi && (n = Hi), super(null, i, r, o, a, c, h, n, l), this.isDepthTexture = true, this.image = {
        width: e,
        height: t
      }, this.magFilter = a !== void 0 ? a : Ct, this.minFilter = c !== void 0 ? c : Ct, this.flipY = false, this.generateMipmaps = false, this.compareFunction = null;
    }
    copy(e) {
  ...
  const sh = new pt(), Uc = new ih(1, 1), rh = new Kl(), oh = new $u(), ah = new th(), Nc = [], Fc = [], Oc = new Float32Array(16), Bc = new Float32Array(9), kc = new Float32Array(4);
  function Ki(s, e, t) {
    const n = s[0];
    if (n <= 0 || n > 0) return s;
    const i = e * t;
  ...
  function wm(s, e, t) {
    ...
    let r;
    this.type === s.SAMPLER_2D_SHADOW ? (Uc.compareFunction = Xl, r = Uc) : r = sh, t.setTexture2D(e || r, i);
  }
  function Rm(s, e, t) {
    const n = this.cache, i = t.allocateTextureUnit();
    n[0] !== i && (s.uniform1i(this.addr, i), n[0] = i), t.setTexture3D(e || oh, i);
  }
  function Cm(s, e, t) {
    const n = this.cache, i = t.allocateTextureUnit();
    n[0] !== i && (s.uniform1i(this.addr, i), n[0] = i), t.setTextureCube(e || ah, i);
  }
  function Pm(s, e, t) {
    const n = this.cache, i = t.allocateTextureUnit();
    n[0] !== i && (s.uniform1i(this.addr, i), n[0] = i), t.setTexture2DArray(e || rh, i);
  }
  function Im(s) {
    switch (s) {
      case 5126:
  ...
  function qm(s, e, t) {
    ...
    for (let o = 0; o !== i; ++o) t.setTexture2D(e[o] || sh, r[o]);
  }
  function Km(s, e, t) {
    const n = this.cache, i = e.length, r = Or(t, i);
    mt(n, r) || (s.uniform1iv(this.addr, r), gt(n, r));
...
`);
  ...
  function rg(s) {
    ...
    let n;
    switch (e === t ? n = "" : e === Pr && t === Cr ? n = "LinearDisplayP3ToLinearSRGB" : e === Cr && t === Pr && (n = "LinearSRGBToLinearDisplayP3"), s) {
      case St:
      case Fr:
        return [
          n,
...
` + sg(s.getShaderSource(e), o);
  ...
  const Js = new R();
  function cg() {
    Ge.getLuminanceCoefficients(Js);
    const s = Js.x.toFixed(4), e = Js.y.toFixed(4), t = Js.z.toFixed(4);
    return [
...
#define LOW_PRECISION`), e;
  ...
  function _g(s) {
    ...
    return s.shadowMapType === Cl ? e = "SHADOWMAP_TYPE_PCF" : s.shadowMapType === Fh ? e = "SHADOWMAP_TYPE_PCF_SOFT" : s.shadowMapType === Mn && (e = "SHADOWMAP_TYPE_VSM"), e;
  }
  function xg(s) {
...
`), p = [
      ...
      t.toneMapping !== Gn ? Le.tonemapping_pars_fragment : "",
      t.toneMapping !== Gn ? ag("toneMapping", t.toneMapping) : "",
      t.dithering ? "#define DITHERING" : "",
      t.opaque ? "#define OPAQUE" : "",
      Le.colorspace_pars_fragment,
      og("linearToOutputTexel", t.outputColorSpace),
      cg(),
...
`) + `
` + p);
    const M = E + m + o, b = E + p + a, I = Hc(i, i.VERTEX_SHADER, M), A = Hc(i, i.FRAGMENT_SHADER, b);
...
` + G);
      ...
      i.deleteShader(I), i.deleteShader(A), U = new Sr(i, _), K = ug(i, _);
    }
    let U;
  ...
  function Ag(s, e, t, n, i, r, o) {
    const a = new jl(), c = new bg(), l = /* @__PURE__ */ new Set(), h = [], u = i.logarithmicDepthBuffer, d = i.reverseDepthBuffer, f = i.vertexTextures;
    let g = i.precision;
    const _ = {
    ...
    function p(x, S, k, B, H) {
      const j = B.fog, z = H.geometry, Q = x.isMeshStandardMaterial ? B.environment : null, G = (x.isMeshStandardMaterial ? t : e).get(x.envMap || Q), ae = G && G.mapping === Nr ? G.image.height : null, ce = _[x.type];
      ...
      const _e = z.morphAttributes.position || z.morphAttributes.normal || z.morphAttributes.color, We = _e !== void 0 ? _e.length : 0;
      let $e = 0;
      ...
      const Pe = s.getRenderTarget(), Ee = H.isInstancedMesh === true, Oe = H.isBatchedMesh === true, Qe = !!x.map, Be = !!x.matcap, C = !!G, Nt = !!x.aoMap, Ne = !!x.lightMap, ze = !!x.bumpMap, Te = !!x.normalMap, it = !!x.displacementMap, Re = !!x.emissiveMap, T = !!x.metalnessMap, v = !!x.roughnessMap, N = x.anisotropy > 0, Y = x.clearcoat > 0, $ = x.dispersion > 0, X = x.iridescence > 0, xe = x.sheen > 0, ne = x.transmission > 0, he = N && !!x.anisotropyMap, He = Y && !!x.clearcoatMap, J = Y && !!x.clearcoatNormalMap, ue = Y && !!x.clearcoatRoughnessMap, Ae = X && !!x.iridescenceMap, we = X && !!x.iridescenceThicknessMap, de = xe && !!x.sheenColorMap, Fe = xe && !!x.sheenRoughnessMap, Ie = !!x.specularMap, nt = !!x.specularColorMap, P = !!x.specularIntensityMap, re = ne && !!x.transmissionMap, V = ne && !!x.thicknessMap, q = !!x.gradientMap, ie = !!x.alphaMap, oe = x.alphaTest > 0, ke = !!x.alphaHash, ut = !!x.extensions;
      let Pt = Gn;
      ...
      const Xe = {
        ...
        precision: g,
        batching: Oe,
        batchingColor: Oe && H._colorsTexture !== null,
        instancing: Ee,
        instancingColor: Ee && H.instanceColor !== null,
        instancingMorph: Ee && H.morphTexture !== null,
        supportsVertexTextures: f,
        outputColorSpace: Pe === null ? s.outputColorSpace : Pe.isXRRenderTarget === true ? Pe.texture.colorSpace : St,
        ...
        emissiveMap: Re,
        normalMapObjectSpace: Te && x.normalMapType === _u,
        normalMapTangentSpace: Te && x.normalMapType === Wl,
        metalnessMap: T,
        roughnessMap: v,
        anisotropy: N,
        anisotropyMap: he,
        ...
        thicknessMap: V,
        gradientMap: q,
        opaque: x.transparent === false && x.blending === Di && x.alphaToCoverage === false,
        alphaMap: ie,
        alphaTest: oe,
        alphaHash: ke,
        combine: x.combine,
        ...
        lightMapUv: Ne && m(x.lightMap.channel),
        ...
        clearcoatMapUv: He && m(x.clearcoatMap.channel),
        ...
        sheenRoughnessMapUv: Fe && m(x.sheenRoughnessMap.channel),
        ...
        extensionClipCullDistance: ut && x.extensions.clipCullDistance === true && n.has("WEBGL_clip_cull_distance"),
        extensionMultiDraw: (ut && x.extensions.multiDraw === true || Oe) && n.has("WEBGL_multi_draw"),
  ...
  function Kc() {
    ...
    function l(u, d) {
      t.length > 1 && t.sort(u || Rg), n.length > 1 && n.sort(d || qc), i.length > 1 && i.sort(d || qc);
    }
    function h() {
  ...
  function Cg() {
    ...
    function e(n, i) {
      const r = s.get(n);
      let o;
      return r === void 0 ? (o = new Kc(), s.set(n, [
        o
      ])) : i >= r.length ? (o = new Kc(), r.push(o)) : o = r[i], o;
    }
    function t() {
      s = /* @__PURE__ */ new WeakMap();
    }
      ...
      for (let K = 0, x = l.length; K < x; K++) {
        ...
        if (S.isAmbientLight) h += k.r * B, u += k.g * B, d += k.b * B;
          ...
          if (z.color.copy(S.color).multiplyScalar(S.intensity), z.distance = S.distance, z.decay = S.decay, S.castShadow) {
            const Q = S.shadow, G = t.get(S);
            G.shadowIntensity = Q.intensity, G.shadowBias = Q.bias, G.shadowNormalBias = Q.normalBias, G.shadowRadius = Q.radius, G.shadowMapSize = Q.mapSize, G.shadowCameraNear = Q.camera.near, G.shadowCameraFar = Q.camera.far, n.pointShadow[g] = G, n.pointShadowMap[g] = j, n.pointShadowMatrix[g] = S.shadow.matrix, M++;
          }
          n.point[g] = z, g++;
  ...
  function Ng(s) {
    ...
    function t(i, r = 0) {
      const o = e.get(i);
      let a;
      return o === void 0 ? (a = new jc(s), e.set(i, [
        a
      ])) : r >= o.length ? (a = new jc(s), o.push(a)) : a = o[r], a;
    }
    function n() {
      e = /* @__PURE__ */ new WeakMap();
    }
...
void main() {
  ...
  function zg(s, e, t) {
    let n = new Oa();
    const i = new me(), r = new me(), o = new Ye(), a = new Fg({
      depthPacking: gu
    }), c = new Og(), l = {}, h = t.maxTextureSize, u = {
      [Tn]: Dt,
      [Dt]: Tn,
      [Xt]: Xt
    }, d = new Wn({
    ...
    this.enabled = false, this.autoUpdate = true, this.needsUpdate = false, this.type = Cl;
    let p = this.type;
    this.render = function(A, w, U) {
      ...
      const B = p !== Mn && this.type === Mn, H = p === Mn && this.type !== Mn;
      for (let j = 0, z = A.length; j < z; j++) {
        ...
        if (i.multiply(ae), r.copy(G.mapSize), (i.x > h || i.y > h) && (i.x > h && (r.x = Math.floor(h / ae.x), i.x = r.x * ae.x, G.mapSize.x = r.x), i.y > h && (r.y = Math.floor(h / ae.y), i.y = r.y * ae.y, G.mapSize.y = r.y)), G.map === null || B === true || H === true) {
          const _e = this.type !== Mn ? {
            minFilter: Ct,
            magFilter: Ct
          } : {};
          G.map !== null && G.map.dispose(), G.map = new oi(i.x, i.y, _e), G.map.texture.name = Q.name + ".shadowMap", G.camera.updateProjectionMatrix();
        }
        s.setRenderTarget(G.map), s.clear();
        const ce = G.getViewportCount();
        for (let _e = 0; _e < ce; _e++) {
          const We = G.getViewport(_e);
          o.set(r.x * We.x, r.y * We.y, r.x * We.z, r.y * We.w), k.viewport(o), G.updateMatrices(Q, _e), n = G.getFrustum(), b(w, U, G.camera, Q, this.type);
        }
        G.isPointLightShadow !== true && this.type === Mn && E(G, U), G.needsUpdate = false;
      }
    ...
    function b(A, w, U, K, x) {
      ...
      if (A.layers.test(w.layers) && (A.isMesh || A.isLine || A.isPoints) && (A.castShadow || A.receiveShadow && x === Mn) && (!A.frustumCulled || n.intersectsObject(A))) {
  ...
  function Vg(s) {
    function e() {
      ...
      return {
        ...
        setClear: function(ie, oe, ke, ut, Pt) {
          Pt === true && (ie *= ut, oe *= ut, ke *= ut), re.set(ie, oe, ke, ut), q.equals(re) === false && (s.clearColor(ie, oe, ke, ut), q.copy(re));
        },
        reset: function() {
    ...
    function n() {
      let P = false, re = null, V = null, q = null, ie = null, oe = null, ke = null, ut = null, Pt = null;
      return {
        setTest: function(Xe) {
        ...
        setFunc: function(Xe, It, fn) {
          (V !== Xe || q !== It || ie !== fn) && (s.stencilFunc(Xe, It, fn), V = Xe, q = It, ie = fn);
        },
        setOp: function(Xe, It, fn) {
          (oe !== Xe || ke !== It || ut !== fn) && (s.stencilOp(Xe, It, fn), oe = Xe, ke = It, ut = fn);
        },
        ...
        reset: function() {
          P = false, re = null, V = null, q = null, ie = null, oe = null, ke = null, ut = null, Pt = null;
        }
      };
    }
    const i = new e(), r = new t(), o = new n(), a = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakMap();
    let l = {}, h = {}, u = /* @__PURE__ */ new WeakMap(), d = [], f = null, g = false, _ = null, m = null, p = null, E = null, M = null, b = null, I = null, A = new Se(0, 0, 0), w = 0, U = false, K = null, x = null, S = null, k = null, B = null;
    ...
    let G = null, ae = {};
    const ce = s.getParameter(s.SCISSOR_BOX), _e = s.getParameter(s.VIEWPORT), We = new Ye().fromArray(ce), $e = new Ye().fromArray(_e);
    function W(P, re, V, q) {
      ...
      for (let ke = 0; ke < V; ke++) P === s.TEXTURE_3D || P === s.TEXTURE_2D_ARRAY ? s.texImage3D(re, 0, s.RGBA, 1, 1, q, 0, s.RGBA, s.UNSIGNED_BYTE, ie) : s.texImage2D(re + ke, 0, s.RGBA, 1, 1, 0, s.RGBA, s.UNSIGNED_BYTE, ie);
      return oe;
    }
    const Z = {};
    Z[s.TEXTURE_2D] = W(s.TEXTURE_2D, s.TEXTURE_2D, 1), Z[s.TEXTURE_CUBE_MAP] = W(s.TEXTURE_CUBE_MAP, s.TEXTURE_CUBE_MAP_POSITIVE_X, 6), Z[s.TEXTURE_2D_ARRAY] = W(s.TEXTURE_2D_ARRAY, s.TEXTURE_2D_ARRAY, 1, 1), Z[s.TEXTURE_3D] = W(s.TEXTURE_3D, s.TEXTURE_3D, 1, 1), i.setClear(0, 0, 0, 1), r.setClear(1), o.setClear(0), pe(s.DEPTH_TEST), r.setFunc(Oi), Ne(false), ze(nc), pe(s.CULL_FACE), C(Vn);
    function pe(P) {
    ...
    const Qe = {
      [ni]: s.FUNC_ADD,
      [Bh]: s.FUNC_SUBTRACT,
      [kh]: s.FUNC_REVERSE_SUBTRACT
    };
    Qe[zh] = s.MIN, Qe[Hh] = s.MAX;
    const Be = {
      [Vh]: s.ZERO,
      [Gh]: s.ONE,
      [Wh]: s.SRC_COLOR,
      [Uo]: s.SRC_ALPHA,
      [$h]: s.SRC_ALPHA_SATURATE,
      [Kh]: s.DST_COLOR,
      [Yh]: s.DST_ALPHA,
      [Xh]: s.ONE_MINUS_SRC_COLOR,
      [No]: s.ONE_MINUS_SRC_ALPHA,
      [jh]: s.ONE_MINUS_DST_COLOR,
      [qh]: s.ONE_MINUS_DST_ALPHA,
      [Zh]: s.CONSTANT_COLOR,
      [Jh]: s.ONE_MINUS_CONSTANT_COLOR,
      [Qh]: s.CONSTANT_ALPHA,
      [eu]: s.ONE_MINUS_CONSTANT_ALPHA
    };
    function C(P, re, V, q, ie, oe, ke, ut, Pt, Xe) {
      if (P === Vn) {
        g === true && (le(s.BLEND), g = false);
        return;
      }
      if (g === false && (pe(s.BLEND), g = true), P !== Oh) {
        if (P !== _ || Xe !== U) {
          if ((m !== ni || M !== ni) && (s.blendEquation(s.FUNC_ADD), m = ni, M = ni), Xe) switch (P) {
            case Di:
      ...
      ie = ie || re, oe = oe || V, ke = ke || q, (re !== m || ie !== M) && (s.blendEquationSeparate(Qe[re], Qe[ie]), m = re, M = ie), (V !== p || q !== E || oe !== b || ke !== I) && (s.blendFuncSeparate(Be[V], Be[q], Be[oe], Be[ke]), p = V, E = q, b = oe, I = ke), (ut.equals(A) === false || Pt !== w) && (s.blendColor(ut.r, ut.g, ut.b, Pt), A.copy(ut), w = Pt), _ = P, U = false;
    }
    function Nt(P, re) {
      P.side === Xt ? le(s.CULL_FACE) : pe(s.CULL_FACE);
      let V = P.side === Dt;
    ...
    function ze(P) {
      P !== Uh ? (pe(s.CULL_FACE), P !== x && (P === nc ? s.cullFace(s.BACK) : P === Nh ? s.cullFace(s.FRONT) : s.cullFace(s.FRONT_AND_BACK))) : le(s.CULL_FACE), x = P;
    }
    function Te(P) {
  ...
  function Wg(s, e, t, n, i, r, o) {
    const a = e.has("WEBGL_multisampled_render_to_texture") ? e.get("WEBGL_multisampled_render_to_texture") : null, c = typeof navigator > "u" ? false : /OculusBrowser/g.test(navigator.userAgent), l = new me(), h = /* @__PURE__ */ new WeakMap();
    let u;
    ...
    function _(T, v, N) {
      ...
      if (($.width > N || $.height > N) && (Y = N / Math.max($.width, $.height)), Y < 1) if (typeof HTMLImageElement < "u" && T instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && T instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && T instanceof ImageBitmap || typeof VideoFrame < "u" && T instanceof VideoFrame) {
        const X = Math.floor(Y * $.width), xe = Math.floor(Y * $.height);
        u === void 0 && (u = g(X, xe));
        const ne = v ? g(X, xe) : u;
    ...
    function m(T) {
      return T.generateMipmaps && T.minFilter !== Ct && T.minFilter !== zt;
    }
    function p(T) {
      s.generateMipmap(T);
    }
    ...
    function M(T, v) {
      let N;
      return T ? v === null || v === ri || v === Hi ? N = s.DEPTH24_STENCIL8 : v === tn ? N = s.DEPTH32F_STENCIL8 : v === vs && (N = s.DEPTH24_STENCIL8, console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")) : v === null || v === ri || v === Hi ? N = s.DEPTH_COMPONENT24 : v === tn ? N = s.DEPTH_COMPONENT32F : v === vs && (N = s.DEPTH_COMPONENT16), N;
    }
    function b(T, v) {
      return m(T) === true || T.isFramebufferTexture && T.minFilter !== Ct && T.minFilter !== zt ? Math.log2(Math.max(v.width, v.height)) + 1 : T.mipmaps !== void 0 && T.mipmaps.length > 0 ? T.mipmaps.length : T.isCompressedTexture && Array.isArray(T.image) ? v.mipmaps.length : 1;
    }
    function I(T) {
      const v = T.target;
    ...
    function _e(T, v) {
      if (v.type === tn && e.has("OES_texture_float_linear") === false && (v.magFilter === zt || v.magFilter === mr || v.magFilter === us || v.magFilter === En || v.minFilter === zt || v.minFilter === mr || v.minFilter === us || v.minFilter === En) && console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), s.texParameteri(T, s.TEXTURE_WRAP_S, G[v.wrapS]), s.texParameteri(T, s.TEXTURE_WRAP_T, G[v.wrapT]), (T === s.TEXTURE_3D || T === s.TEXTURE_2D_ARRAY) && s.texParameteri(T, s.TEXTURE_WRAP_R, G[v.wrapR]), s.texParameteri(T, s.TEXTURE_MAG_FILTER, ae[v.magFilter]), s.texParameteri(T, s.TEXTURE_MIN_FILTER, ae[v.minFilter]), v.compareFunction && (s.texParameteri(T, s.TEXTURE_COMPARE_MODE, s.COMPARE_REF_TO_TEXTURE), s.texParameteri(T, s.TEXTURE_COMPARE_FUNC, ce[v.compareFunction])), e.has("EXT_texture_filter_anisotropic") === true) {
        if (v.magFilter === Ct || v.minFilter !== us && v.minFilter !== En || v.type === tn && e.has("OES_texture_float_linear") === false) return;
    ...
    function $e(T, v, N) {
      ...
      if (X.version !== xe.__version || $ === true) {
        ...
        if (v.isDepthTexture) we = M(v.format === Vi, v.type), nt && (Ie ? t.texStorage2D(s.TEXTURE_2D, 1, we, J.width, J.height) : t.texImage2D(s.TEXTURE_2D, 0, we, J.width, J.height, 0, ue, Ae, null));
        else if (v.isDataTexture) if (Fe.length > 0) {
          Ie && nt && t.texStorage2D(s.TEXTURE_2D, re, we, Fe[0].width, Fe[0].height);
          for (let V = 0, q = Fe.length; V < q; V++) de = Fe[V], Ie ? P && t.texSubImage2D(s.TEXTURE_2D, V, 0, 0, de.width, de.height, ue, Ae, de.data) : t.texImage2D(s.TEXTURE_2D, V, we, de.width, de.height, 0, ue, Ae, de.data);
          ...
          for (let V = 0, q = Fe.length; V < q; V++) if (de = Fe[V], v.format !== qt) if (ue !== null) if (Ie) {
          ...
          for (let V = 0, q = Fe.length; V < q; V++) de = Fe[V], Ie ? P && t.texSubImage2D(s.TEXTURE_2D, V, 0, 0, ue, Ae, de) : t.texImage2D(s.TEXTURE_2D, V, we, ue, Ae, de);
          v.generateMipmaps = false;
        } else if (Ie) {
          if (nt) {
            const V = Re(J);
        ...
        m(v) && p(Y), xe.__version = X.version, v.onUpdate && v.onUpdate(v);
      }
    ...
    function W(T, v, N) {
      ...
      if ($.version !== X.__version || Y === true) {
        ...
        for (let q = 0; q < 6; q++) !He && !J ? ue[q] = _(v.image[q], true, i.maxCubemapSize) : ue[q] = J ? v.image[q].image : v.image[q], ue[q] = it(v, ue[q]);
        const Ae = ue[0], we = r.convert(v.format, v.colorSpace), de = r.convert(v.type), Fe = E(v.internalFormat, we, de, v.colorSpace), Ie = v.isVideoTexture !== true, nt = X.__version === void 0 || Y === true, P = $.dataReady;
        let re = b(v, Ae);
        _e(s.TEXTURE_CUBE_MAP, v);
        let V;
        if (He) {
          ...
          if (V = v.mipmaps, Ie && nt) {
            V.length > 0 && re++;
            const q = Re(ue[0]);
            t.texStorage2D(s.TEXTURE_CUBE_MAP, re, Fe, q.width, q.height);
          }
          for (let q = 0; q < 6; q++) if (J) {
            Ie ? P && t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, 0, 0, 0, ue[q].width, ue[q].height, we, de, ue[q].data) : t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, 0, Fe, ue[q].width, ue[q].height, 0, we, de, ue[q].data);
            for (let ie = 0; ie < V.length; ie++) {
              const ke = V[ie].image[q].image;
              Ie ? P && t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, ie + 1, 0, 0, ke.width, ke.height, we, de, ke.data) : t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, ie + 1, Fe, ke.width, ke.height, 0, we, de, ke.data);
            }
          } else {
            Ie ? P && t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, 0, 0, 0, we, de, ue[q]) : t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, 0, Fe, we, de, ue[q]);
            for (let ie = 0; ie < V.length; ie++) {
              const oe = V[ie];
              Ie ? P && t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, ie + 1, 0, 0, we, de, oe.image[q]) : t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, ie + 1, Fe, we, de, oe.image[q]);
            }
          }
        }
    ...
    function Z(T, v, N, Y, $, X) {
      ...
      t.bindFramebuffer(s.FRAMEBUFFER, T), ze(v) ? a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER, Y, $, n.get(N).__webglTexture, 0, Ne(v)) : ($ === s.TEXTURE_2D || $ >= s.TEXTURE_CUBE_MAP_POSITIVE_X && $ <= s.TEXTURE_CUBE_MAP_NEGATIVE_Z) && s.framebufferTexture2D(s.FRAMEBUFFER, Y, $, n.get(N).__webglTexture, X), t.bindFramebuffer(s.FRAMEBUFFER, null);
    }
    function pe(T, v, N) {
      if (s.bindRenderbuffer(s.RENDERBUFFER, T), v.depthBuffer) {
        const Y = v.depthTexture, $ = Y && Y.isDepthTexture ? Y.type : null, X = M(v.stencilBuffer, $), xe = v.stencilBuffer ? s.DEPTH_STENCIL_ATTACHMENT : s.DEPTH_ATTACHMENT, ne = Ne(v);
        ...
        const Y = v.textures;
        for (let $ = 0; $ < Y.length; $++) {
          const X = Y[$], xe = r.convert(X.format, X.colorSpace), ne = r.convert(X.type), he = E(X.internalFormat, xe, ne, X.colorSpace), He = Ne(v);
    ...
    function le(T, v) {
      ...
      const Y = n.get(v.depthTexture).__webglTexture, $ = Ne(v);
      if (v.depthTexture.format === Ui) ze(v) ? a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER, s.DEPTH_ATTACHMENT, s.TEXTURE_2D, Y, 0, $) : s.framebufferTexture2D(s.FRAMEBUFFER, s.DEPTH_ATTACHMENT, s.TEXTURE_2D, Y, 0);
      else if (v.depthTexture.format === Vi) ze(v) ? a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER, s.DEPTH_STENCIL_ATTACHMENT, s.TEXTURE_2D, Y, 0, $) : s.framebufferTexture2D(s.FRAMEBUFFER, s.DEPTH_STENCIL_ATTACHMENT, s.TEXTURE_2D, Y, 0);
    ...
    function Oe(T) {
      ...
      if (xe || (Y.__webglTexture === void 0 && (Y.__webglTexture = s.createTexture()), Y.__version = v.version, o.memory.textures++), X) {
      ...
      if (X) {
        t.bindTexture(s.TEXTURE_CUBE_MAP, Y.__webglTexture), _e(s.TEXTURE_CUBE_MAP, v);
        ...
        for (let ne = 0, he = $.length; ne < he; ne++) {
          ...
          t.bindTexture(s.TEXTURE_2D, J.__webglTexture), _e(s.TEXTURE_2D, He), Z(N.__webglFramebuffer, T, He, s.COLOR_ATTACHMENT0 + ne, s.TEXTURE_2D, 0), m(He) && p(s.TEXTURE_2D);
        }
        t.unbindTexture();
      } else {
        let ne = s.TEXTURE_2D;
        if ((T.isWebGL3DRenderTarget || T.isWebGLArrayRenderTarget) && (ne = T.isWebGL3DRenderTarget ? s.TEXTURE_3D : s.TEXTURE_2D_ARRAY), t.bindTexture(ne, Y.__webglTexture), _e(ne, v), v.mipmaps && v.mipmaps.length > 0) for (let he = 0; he < v.mipmaps.length; he++) Z(N.__webglFramebuffer[he], T, v, s.COLOR_ATTACHMENT0, ne, he);
      ...
      if (T.samples > 0) {
        if (ze(T) === false) {
          ...
          for (let he = 0; he < v.length; he++) {
            ...
            s.blitFramebuffer(0, 0, N, Y, 0, 0, N, Y, $, s.NEAREST), c === true && (Be.length = 0, C.length = 0, Be.push(s.COLOR_ATTACHMENT0 + he), T.depthBuffer && T.resolveDepthBuffer === false && (Be.push(X), C.push(X), s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER, C)), s.invalidateFramebuffer(s.READ_FRAMEBUFFER, Be));
          }
    ...
    function it(T, v) {
      ...
      return T.isCompressedTexture === true || T.isVideoTexture === true || N !== St && N !== kn && (Ge.getTransfer(N) === rt ? (Y !== qt || $ !== An) && console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture color space:", N)), v;
    }
    function Re(T) {
  ...
  function Xg(s, e) {
    function t(n, i = kn) {
      ...
      if (n === Nl) return s.UNSIGNED_INT_5_9_9_9_REV;
      if (n === Dl) return s.BYTE;
      if (n === Ul) return s.SHORT;
      if (n === vs) return s.UNSIGNED_SHORT;
      if (n === wa) return s.INT;
      if (n === ri) return s.UNSIGNED_INT;
      if (n === tn) return s.FLOAT;
      if (n === As) return s.HALF_FLOAT;
      if (n === Fl) return s.ALPHA;
      if (n === Ol) return s.RGB;
      if (n === qt) return s.RGBA;
      if (n === Bl) return s.LUMINANCE;
      if (n === kl) return s.LUMINANCE_ALPHA;
      ...
      if (n === gr || n === _r || n === xr || n === vr) if (o === rt) if (r = e.get("WEBGL_compressed_texture_s3tc_srgb"), r !== null) {
      ...
      if (n === Xo || n === Yo || n === qo || n === Ko) if (r = e.get("WEBGL_compressed_texture_pvrtc"), r !== null) {
        if (n === Xo) return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
        if (n === Yo) return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
        if (n === qo) return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
      ...
      if (n === yr || n === da || n === fa) if (r = e.get("EXT_texture_compression_bptc"), r !== null) {
        if (n === yr) return o === rt ? r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT : r.COMPRESSED_RGBA_BPTC_UNORM_EXT;
        if (n === da) return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
        if (n === fa) return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
      if (n === Hl || n === pa || n === ma || n === ga) if (r = e.get("EXT_texture_compression_rgtc"), r !== null) {
        if (n === yr) return r.COMPRESSED_RED_RGTC1_EXT;
  ...
  class yo {
    ...
    getHandSpace() {
      return this._hand === null && (this._hand = new nn(), this._hand.matrixAutoUpdate = false, this._hand.visible = false, this._hand.joints = {}, this._hand.inputState = {
        pinching: false
      }), this._hand;
    }
    getTargetRaySpace() {
      return this._targetRay === null && (this._targetRay = new nn(), this._targetRay.matrixAutoUpdate = false, this._targetRay.visible = false, this._targetRay.hasLinearVelocity = false, this._targetRay.linearVelocity = new R(), this._targetRay.hasAngularVelocity = false, this._targetRay.angularVelocity = new R()), this._targetRay;
    }
    getGripSpace() {
      return this._grip === null && (this._grip = new nn(), this._grip.matrixAutoUpdate = false, this._grip.visible = false, this._grip.hasLinearVelocity = false, this._grip.linearVelocity = new R(), this._grip.hasAngularVelocity = false, this._grip.angularVelocity = new R()), this._grip;
    }
    dispatchEvent(e) {
    ...
    update(e, t, n) {
      ...
      if (e && t.session.visibilityState !== "visible-blurred") {
        ...
        a !== null && (i = t.getPose(e.targetRaySpace, n), i === null && r !== null && (i = r), i !== null && (a.matrix.fromArray(i.transform.matrix), a.matrix.decompose(a.position, a.rotation, a.scale), a.matrixWorldNeedsUpdate = true, i.linearVelocity ? (a.hasLinearVelocity = true, a.linearVelocity.copy(i.linearVelocity)) : a.hasLinearVelocity = false, i.angularVelocity ? (a.hasAngularVelocity = true, a.angularVelocity.copy(i.angularVelocity)) : a.hasAngularVelocity = false, this.dispatchEvent(qg)));
      }
...
void main() {
  ...
  class $g {
    ...
    getMesh(e) {
      if (this.texture !== null && this.mesh === null) {
        ...
        this.mesh = new tt(new si(20, 20), n);
      }
      return this.mesh;
    }
    reset() {
  ...
  class Zg extends Xn {
    constructor(e, t) {
      ...
      this.cameraAutoUpdate = true, this.enabled = false, this.isPresenting = false, this.getController = function(W) {
        let Z = M[W];
        return Z === void 0 && (Z = new yo(), M[W] = Z), Z.getTargetRaySpace();
      }, this.getControllerGrip = function(W) {
        let Z = M[W];
        return Z === void 0 && (Z = new yo(), M[W] = Z), Z.getGripSpace();
      }, this.getHand = function(W) {
        let Z = M[W];
        return Z === void 0 && (Z = new yo(), M[W] = Z), Z.getHandSpace();
      };
      function B(W) {
        ...
        if (i = W, i !== null) {
          if (p = e.getRenderTarget(), i.addEventListener("select", B), i.addEventListener("selectstart", B), i.addEventListener("selectend", B), i.addEventListener("squeeze", B), i.addEventListener("squeezestart", B), i.addEventListener("squeezeend", B), i.addEventListener("end", H), i.addEventListener("inputsourceschange", j), m.xrCompatible !== true && await t.makeXRCompatible(), A = e.getPixelRatio(), e.getSize(I), i.renderState.layers === void 0) {
            ...
            f = new XRWebGLLayer(i, t, Z), i.updateRenderState({
              baseLayer: f
            }), e.setPixelRatio(1), e.setSize(f.framebufferWidth, f.framebufferHeight, false), E = new oi(f.framebufferWidth, f.framebufferHeight, {
              format: qt,
              type: An,
            ...
            m.depth && (le = m.stencil ? t.DEPTH24_STENCIL8 : t.DEPTH_COMPONENT24, Z = m.stencil ? Vi : Ui, pe = m.stencil ? Hi : ri);
            const Pe = {
              colorFormat: t.RGBA8,
              depthFormat: le,
              scaleFactor: r
            ...
            }), e.setPixelRatio(1), e.setSize(d.textureWidth, d.textureHeight, false), E = new oi(d.textureWidth, d.textureHeight, {
              format: qt,
              type: An,
              depthTexture: new ih(d.textureWidth, d.textureHeight, pe, void 0, void 0, void 0, void 0, void 0, void 0, Z),
              stencilBuffer: m.stencil,
              colorSpace: e.outputColorSpace,
      ...
      function G(W, Z, pe) {
        ...
        const le = z.distanceTo(Q), Pe = Z.projectionMatrix.elements, Ee = pe.projectionMatrix.elements, Oe = Pe[14] / (Pe[10] - 1), Qe = Pe[14] / (Pe[10] + 1), Be = (Pe[9] + 1) / Pe[5], C = (Pe[9] - 1) / Pe[5], Nt = (Pe[8] - 1) / Pe[0], Ne = (Ee[8] + 1) / Ee[0], ze = Oe * Nt, Te = Oe * Ne, it = le / (-Nt + Ne), Re = it * -Nt;
        if (Z.matrixWorld.decompose(W.position, W.quaternion, W.scale), W.translateX(Re), W.translateZ(it), W.matrixWorld.compose(W.position, W.quaternion, W.scale), W.matrixWorldInverse.copy(W.matrixWorld).invert(), Pe[10] === -1) W.projectionMatrix.copy(Z.projectionMatrix), W.projectionMatrixInverse.copy(Z.projectionMatrixInverse);
          ...
          const T = Oe + it, v = Qe + it, N = ze - Re, Y = Te + (le - Re), $ = Be * Qe / v * T, X = C * Qe / v * T;
      ...
      function We(W, Z) {
        if (h = Z.getViewerPose(l || o), g = Z, h !== null) {
          ...
          for (let Ee = 0; Ee < pe.length; Ee++) {
            ...
            let Be = K[Ee];
            Be === void 0 && (Be = new Rt(), Be.layers.enable(Ee), Be.viewport = new Ye(), K[Ee] = Be), Be.matrix.fromArray(Oe.transform.matrix), Be.matrix.decompose(Be.position, Be.quaternion, Be.scale), Be.projectionMatrix.fromArray(Oe.projectionMatrix), Be.projectionMatrixInverse.copy(Be.projectionMatrix).invert(), Be.viewport.set(Qe.x, Qe.y, Qe.width, Qe.height), Ee === 0 && (x.matrix.copy(Be.matrix), x.matrix.decompose(x.position, x.quaternion, x.scale)), le === true && x.cameras.push(Be);
          }
        ...
        _e && _e(W, Z), Z.detectedPlanes && n.dispatchEvent({
          type: "planesdetected",
          data: Z
        }), g = null;
      }
  ...
  const Jn = new cn(), Jg = new Ce();
  function Qg(s, e) {
    function t(m, p) {
      m.matrixAutoUpdate === true && m.updateMatrix(), p.value.copy(m.matrix);
    }
    function n(m, p) {
      p.color.getRGB(m.fogColor.value, Ql(s)), p.isFog ? (m.fogNear.value = p.near, m.fogFar.value = p.far) : p.isFogExp2 && (m.fogDensity.value = p.density);
    }
  ...
  function e_(s, e, t, n) {
    ...
    function g(E) {
      ...
      for (let w = 0, U = M.length; w < U; w++) {
        const K = Array.isArray(M[w]) ? M[w] : [
          M[w]
        ];
        for (let x = 0, S = K.length; x < S; x++) {
          const k = K[x], B = Array.isArray(k.value) ? k.value : [
            k.value
          ];
  ...
  class t_ {
    constructor(e = {}) {
      ...
      this.domElement = t, this.debug = {
        ...
        onShaderError: null
      }, this.autoClear = true, this.autoClearColor = true, this.autoClearDepth = true, this.autoClearStencil = true, this.sortObjects = true, this.clippingPlanes = [], this.localClippingEnabled = false, this._outputColorSpace = wt, this.toneMapping = Gn, this.toneMappingExposure = 1;
      const M = this;
      ...
      const ce = new Ye(0, 0, j, z), _e = new Ye(0, 0, j, z);
      let We = false;
      const $e = new Oa();
      let W = false, Z = false;
      const pe = new Ce(), le = new Ce(), Pe = new R(), Ee = new Ye(), Oe = {
        background: null,
        fog: null,
        environment: null,
      ...
      try {
        ...
        if ("setAttribute" in t && t.setAttribute("data-engine", `three.js r${Aa}`), t.addEventListener("webglcontextlost", q, false), t.addEventListener("webglcontextrestored", ie, false), t.addEventListener("webglcontextcreationerror", oe, false), C === null) {
          const L = "webgl2";
      ...
      let Ne, ze, Te, it, Re, T, v, N, Y, $, X, xe, ne, he, He, J, ue, Ae, we, de, Fe, Ie, nt, P;
      function re() {
        Ne = new om(C), Ne.init(), Ie = new Xg(C, Ne), ze = new em(C, Ne, e, Ie), Te = new Vg(C), ze.reverseDepthBuffer && Te.buffers.depth.setReversed(true), it = new lm(C), Re = new wg(), T = new Wg(C, Ne, Te, Re, ze, Ie, it), v = new nm(M), N = new rm(M), Y = new md(C), nt = new Jp(C, Y), $ = new am(C, Y, it, nt), X = new um(C, $, Y, it), we = new hm(C, ze, T), J = new tm(Re), xe = new Ag(M, v, N, Ne, ze, nt, J), ne = new Qg(M, Re), he = new Cg(), He = new Ng(Ne), Ae = new Zp(M, v, N, Te, X, d, c), ue = new zg(M, X, ze), P = new e_(C, it, ze, Te), de = new Qp(C, Ne, it), Fe = new cm(C, Ne, it), it.programs = xe.programs, M.capabilities = ze, M.extensions = Ne, M.properties = Re, M.renderLists = he, M.shadowMap = ue, M.state = Te, M.info = it;
      }
      re();
      const V = new Zg(M, C);
      this.xr = V, this.getContext = function() {
        ...
        y !== void 0 && (Q = y, this.setSize(j, z, false));
        ...
        j = y, z = L, t.width = Math.floor(y * Q), t.height = Math.floor(L * Q), F === true && (t.style.width = y + "px", t.style.height = L + "px"), this.setViewport(0, 0, y, L);
      }, this.getDrawingBufferSize = function(y) {
        return y.set(j * Q, z * Q).floor();
      }, this.setDrawingBufferSize = function(y, L, F) {
        j = y, z = L, Q = F, t.width = Math.floor(y * F), t.height = Math.floor(L * F), this.setViewport(0, 0, y, L);
        ...
        y.isVector4 ? _e.set(y.x, y.y, y.z, y.w) : _e.set(y, L, F, O), Te.scissor(S.copy(_e).multiplyScalar(Q).round());
        ...
        if (y) {
          ...
          if (D) {
            const ee = w.texture.type, se = ee === An || ee === ri || ee === vs || ee === Hi || ee === Ra || ee === Ca, fe = Ae.getClearColor(), ge = Ae.getClearAlpha(), Me = fe.r, be = fe.g, ve = fe.b;
        ...
        t.removeEventListener("webglcontextlost", q, false), t.removeEventListener("webglcontextrestored", ie, false), t.removeEventListener("webglcontextcreationerror", oe, false), he.dispose(), He.dispose(), Re.dispose(), v.dispose(), N.dispose(), X.dispose(), nt.dispose(), P.dispose(), xe.dispose(), V.dispose(), V.removeEventListener("sessionstart", Ka), V.removeEventListener("sessionend", ja), Yn.stop();
      };
      function q(y) {
      ...
      function Pt(y) {
        ...
        L !== void 0 && (L.forEach(function(F) {
          xe.releaseProgram(F);
        }), y.isShaderMaterial && xe.releaseShaderCache(y));
      }
      this.renderBufferDirect = function(y, L, F, O, D, ee) {
        L === null && (L = Oe);
        const se = D.isMesh && D.matrixWorld.determinant() < 0, fe = Ph(y, L, F, O, D);
        Te.setMaterial(O, se);
        let ge = F.index, Me = 1;
        if (O.wireframe === true) {
        ...
        nt.setup(D, O, fe, F, ge);
        let Ft, qe = de;
        if (ge !== null && (Ft = Y.get(ge), qe = Fe, qe.setIndex(Ft)), D.isMesh) O.wireframe === true ? (Te.setLineWidth(O.wireframeLinewidth * Be()), qe.setMode(C.LINES)) : qe.setMode(C.TRIANGLES);
        else if (D.isLine) {
          let ye = O.linewidth;
          ye === void 0 && (ye = 1), Te.setLineWidth(ye * Be()), D.isLineSegments ? qe.setMode(C.LINES) : D.isLineLoop ? qe.setMode(C.LINE_LOOP) : qe.setMode(C.LINE_STRIP);
        ...
        if (D.isBatchedMesh) if (D._multiDrawInstances !== null) qe.renderMultiDrawInstances(D._multiDrawStarts, D._multiDrawCounts, D._multiDrawCount, D._multiDrawInstances);
        else if (Ne.get("WEBGL_multi_draw")) qe.renderMultiDraw(D._multiDrawStarts, D._multiDrawCounts, D._multiDrawCount);
        else {
          const ye = D._multiDrawStarts, yt = D._multiDrawCounts, Ke = D._multiDrawCount, Kt = ge ? Y.get(ge).bytesPerElement : 1, ai = Re.get(O).currentProgram.getUniforms();
          for (let Ot = 0; Ot < Ke; Ot++) ai.setValue(C, "_gl_DrawID", Ot), qe.render(ye[Ot] / Kt, yt[Ot]);
        }
          ...
          qe.renderInstances(Ze, ct, yt);
        } else qe.render(Ze, ct);
      };
      function Xe(y, L, F) {
        y.transparent === true && y.side === Xt && y.forceSinglePass === false ? (y.side = Dt, y.needsUpdate = true, Ls(y, L, F), y.side = Tn, y.needsUpdate = true, Ls(y, L, F), y.side = Xt) : Ls(y, L, F);
      }
      this.compile = function(y, L, F = null) {
        F === null && (F = y), m = He.get(F), m.init(L), E.push(m), F.traverseVisible(function(D) {
      ...
      const Yn = new nh();
      Yn.setAnimationLoop(fn), typeof self < "u" && Yn.setContext(self), this.setAnimationLoop = function(y) {
        It = y, V.setAnimationLoop(y), y === null ? Yn.stop() : Yn.start();
      }, V.addEventListener("sessionstart", Ka), V.addEventListener("sessionend", ja), this.render = function(y, L) {
        if (L !== void 0 && L.isCamera !== true) {
          console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
          return;
        }
        if (b === true) return;
        if (y.matrixWorldAutoUpdate === true && y.updateMatrixWorld(), L.parent === null && L.matrixWorldAutoUpdate === true && L.updateMatrixWorld(), V.enabled === true && V.isPresenting === true && (V.cameraAutoUpdate === true && V.updateCamera(L), L = V.getCamera()), y.isScene === true && y.onBeforeRender(M, y, L, w), m = He.get(y, E.length), m.init(L), E.push(m), le.multiplyMatrices(L.projectionMatrix, L.matrixWorldInverse), $e.setFromProjectionMatrix(le), Z = this.localClippingEnabled, W = J.init(this.clippingPlanes, Z), _ = he.get(y, p.length), _.init(), p.push(_), V.enabled === true && V.isPresenting === true) {
          const ee = M.xr.getDepthSensingMesh();
          ee !== null && Hr(ee, L, -1 / 0, M.sortObjects);
        }
        Hr(y, L, 0, M.sortObjects), _.finish(), M.sortObjects === true && _.sort(G, ae), Qe = V.enabled === false || V.isPresenting === false || V.hasDepthSensing() === false, Qe && Ae.addToRenderList(_, y), this.info.render.frame++, W === true && J.beginShadows();
        ...
        if (m.setupLights(), L.isArrayCamera) {
          ...
          for (let se = 0, fe = ee.length; se < fe; se++) {
            const ge = ee[se];
            $a(_, y, ge, ge.viewport);
          }
        } else D.length > 0 && Za(O, D, y, L), Qe && Ae.render(y), $a(_, y, L);
        w !== null && (T.updateMultisampleRenderTarget(w), T.updateRenderTargetMipmap(w)), y.isScene === true && y.onAfterRender(M, y, L), nt.resetDefaultState(), U = -1, K = null, E.pop(), E.length > 0 ? (m = E[E.length - 1], W === true && J.setGlobalState(M.clippingPlanes, m.state.camera)) : m = null, p.pop(), p.length > 0 ? _ = p[p.length - 1] : _ = null;
      };
      function Hr(y, L, F, O) {
          ...
          if (y.isGroup) F = y.renderOrder;
            ...
            if (O && (y.boundingSphere !== void 0 ? (y.boundingSphere === null && y.computeBoundingSphere(), Ee.copy(y.boundingSphere.center)) : (se.boundingSphere === null && se.computeBoundingSphere(), Ee.copy(se.boundingSphere.center)), Ee.applyMatrix4(y.matrixWorld).applyMatrix4(le)), Array.isArray(fe)) {
              ...
              for (let Me = 0, be = ge.length; Me < be; Me++) {
                const ve = ge[Me], Ze = fe[ve.materialIndex];
                Ze && Ze.visible && _.push(y, se, Ze, F, Ee.z, ve);
              }
            } else fe.visible && _.push(y, se, fe, F, Ee.z, null);
          }
        }
        const ee = y.children;
        for (let se = 0, fe = ee.length; se < fe; se++) Hr(ee[se], L, F, O);
      }
      function $a(y, L, F, O) {
        const D = y.opaque, ee = y.transmissive, se = y.transparent;
        m.setupLightsView(F), W === true && J.setGlobalState(M.clippingPlanes, F), O && Te.viewport(x.copy(O)), D.length > 0 && Is(D, L, F), ee.length > 0 && Is(ee, L, F), se.length > 0 && Is(se, L, F), Te.buffers.depth.setTest(true), Te.buffers.depth.setMask(true), Te.buffers.color.setMask(true), Te.setPolygonOffset(false);
      }
      function Za(y, L, F, O) {
        if ((F.isScene === true ? F.overrideMaterial : null) !== null) return;
        m.state.transmissionRenderTarget[O.id] === void 0 && (m.state.transmissionRenderTarget[O.id] = new oi(1, 1, {
          generateMipmaps: true,
          type: Ne.has("EXT_color_buffer_half_float") || Ne.has("EXT_color_buffer_float") ? As : An,
          minFilter: En,
          samples: 4,
          stencilBuffer: r,
        ...
        M.toneMapping = Gn;
        const Me = O.viewport;
        if (O.viewport !== void 0 && (O.viewport = void 0), m.setupLightsView(O), W === true && J.setGlobalState(M.clippingPlanes, O), Is(y, F, O), T.updateMultisampleRenderTarget(ee), T.updateRenderTargetMipmap(ee), Ne.has("WEBGL_multisampled_render_to_texture") === false) {
          let be = false;
          for (let ve = 0, Ze = L.length; ve < Ze; ve++) {
            const st = L[ve], ct = st.object, Ft = st.geometry, qe = st.material, ye = st.group;
            if (qe.side === Xt && ct.layers.test(O.layers)) {
              const yt = qe.side;
              qe.side = Dt, qe.needsUpdate = true, Ja(ct, F, O, Ft, qe, ye), qe.side = yt, qe.needsUpdate = true, be = true;
            }
          }
          be === true && (T.updateMultisampleRenderTarget(ee), T.updateRenderTargetMipmap(ee));
        }
        M.setRenderTarget(fe), M.setClearColor(B, H), Me !== void 0 && (O.viewport = Me), M.toneMapping = ge;
      }
      function Is(y, L, F) {
        const O = L.isScene === true ? L.overrideMaterial : null;
        for (let D = 0, ee = y.length; D < ee; D++) {
          const se = y[D], fe = se.object, ge = se.geometry, Me = O === null ? se.material : O, be = se.group;
          fe.layers.test(F.layers) && Ja(fe, L, F, ge, Me, be);
        }
      }
      function Ja(y, L, F, O, D, ee) {
        y.onBeforeRender(M, L, F, O, D, ee), y.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse, y.matrixWorld), y.normalMatrix.getNormalMatrix(y.modelViewMatrix), D.onBeforeRender(M, L, F, O, y, ee), D.transparent === true && D.side === Xt && D.forceSinglePass === false ? (D.side = Dt, D.needsUpdate = true, M.renderBufferDirect(F, L, O, D, y, ee), D.side = Tn, D.needsUpdate = true, M.renderBufferDirect(F, L, O, D, y, ee), D.side = Xt) : M.renderBufferDirect(F, L, O, D, y, ee), y.onAfterRender(M, L, F, O, D, ee);
      }
      function Ls(y, L, F) {
        L.isScene !== true && (L = Oe);
        const O = Re.get(y), D = m.state.lights, ee = m.state.shadowsArray, se = D.state.version, fe = xe.getParameters(y, D.state, ee, L, F), ge = xe.getProgramCacheKey(fe);
        let Me = O.programs;
        O.environment = y.isMeshStandardMaterial ? L.environment : null, O.fog = L.fog, O.envMap = (y.isMeshStandardMaterial ? N : v).get(y.envMap || O.environment), O.envMapRotation = O.environment !== null && y.envMap === null ? L.environmentRotation : y.envMapRotation, Me === void 0 && (y.addEventListener("dispose", ke), Me = /* @__PURE__ */ new Map(), O.programs = Me);
        let be = Me.get(ge);
        if (be !== void 0) {
          if (O.currentProgram === be && O.lightsStateVersion === se) return ec(y, fe), be;
        } else fe.uniforms = xe.getUniforms(y), y.onBeforeCompile(fe, M), be = xe.acquireProgram(fe, ge), Me.set(ge, be), O.uniforms = fe.uniforms;
        const ve = O.uniforms;
        return (!y.isShaderMaterial && !y.isRawShaderMaterial || y.clipping === true) && (ve.clippingPlanes = J.uniform), ec(y, fe), O.needsLights = Lh(y), O.lightsStateVersion = se, O.needsLights && (ve.ambientLightColor.value = D.state.ambient, ve.lightProbe.value = D.state.probe, ve.directionalLights.value = D.state.directional, ve.directionalLightShadows.value = D.state.directionalShadow, ve.spotLights.value = D.state.spot, ve.spotLightShadows.value = D.state.spotShadow, ve.rectAreaLights.value = D.state.rectArea, ve.ltc_1.value = D.state.rectAreaLTC1, ve.ltc_2.value = D.state.rectAreaLTC2, ve.pointLights.value = D.state.point, ve.pointLightShadows.value = D.state.pointShadow, ve.hemisphereLights.value = D.state.hemi, ve.directionalShadowMap.value = D.state.directionalShadowMap, ve.directionalShadowMatrix.value = D.state.directionalShadowMatrix, ve.spotShadowMap.value = D.state.spotShadowMap, ve.spotLightMatrix.value = D.state.spotLightMatrix, ve.spotLightMap.value = D.state.spotLightMap, ve.pointShadowMap.value = D.state.pointShadowMap, ve.pointShadowMatrix.value = D.state.pointShadowMatrix), O.currentProgram = be, O.uniformsList = null, be;
      }
      function Qa(y) {
        if (y.uniformsList === null) {
          const L = y.currentProgram.getUniforms();
          y.uniformsList = Sr.seqWithValue(L.seq, y.uniforms);
        }
      ...
      function Ph(y, L, F, O, D) {
        L.isScene !== true && (L = Oe), T.resetTextureUnits();
        const ee = L.fog, se = O.isMeshStandardMaterial ? L.environment : null, fe = w === null ? M.outputColorSpace : w.isXRRenderTarget === true ? w.texture.colorSpace : St, ge = (O.isMeshStandardMaterial ? N : v).get(O.envMap || se), Me = O.vertexColors === true && !!F.attributes.color && F.attributes.color.itemSize === 4, be = !!F.attributes.tangent && (!!O.normalMap || O.anisotropy > 0), ve = !!F.morphAttributes.position, Ze = !!F.morphAttributes.normal, st = !!F.morphAttributes.color;
        let ct = Gn;
        O.toneMapped && (w === null || w.isXRRenderTarget === true) && (ct = M.toneMapping);
        const Ft = F.morphAttributes.position || F.morphAttributes.normal || F.morphAttributes.color, qe = Ft !== void 0 ? Ft.length : 0, ye = Re.get(O), yt = m.state.lights;
        if (W === true && (Z === true || y !== K)) {
          const Vt = y === K && O.id === U;
          J.setState(O, y, Vt);
        }
        let Ke = false;
        O.version === ye.__version ? (ye.needsLights && ye.lightsStateVersion !== yt.state.version || ye.outputColorSpace !== fe || D.isBatchedMesh && ye.batching === false || !D.isBatchedMesh && ye.batching === true || D.isBatchedMesh && ye.batchingColor === true && D.colorTexture === null || D.isBatchedMesh && ye.batchingColor === false && D.colorTexture !== null || D.isInstancedMesh && ye.instancing === false || !D.isInstancedMesh && ye.instancing === true || D.isSkinnedMesh && ye.skinning === false || !D.isSkinnedMesh && ye.skinning === true || D.isInstancedMesh && ye.instancingColor === true && D.instanceColor === null || D.isInstancedMesh && ye.instancingColor === false && D.instanceColor !== null || D.isInstancedMesh && ye.instancingMorph === true && D.morphTexture === null || D.isInstancedMesh && ye.instancingMorph === false && D.morphTexture !== null || ye.envMap !== ge || O.fog === true && ye.fog !== ee || ye.numClippingPlanes !== void 0 && (ye.numClippingPlanes !== J.numPlanes || ye.numIntersection !== J.numIntersection) || ye.vertexAlphas !== Me || ye.vertexTangents !== be || ye.morphTargets !== ve || ye.morphNormals !== Ze || ye.morphColors !== st || ye.toneMapping !== ct || ye.morphTargetsCount !== qe) && (Ke = true) : (Ke = true, ye.__version = O.version);
        let Kt = ye.currentProgram;
        Ke === true && (Kt = Ls(O, L, D));
        let ai = false, Ot = false, Vr = false;
        const ht = Kt.getUniforms(), Rn = ye.uniforms;
        if (Te.useProgram(Kt.program) && (ai = true, Ot = true, Vr = true), O.id !== U && (U = O.id, Ot = true), ai || K !== y) {
          ze.reverseDepthBuffer ? (pe.copy(y.projectionMatrix), Gu(pe), Wu(pe), ht.setValue(C, "projectionMatrix", pe)) : ht.setValue(C, "projectionMatrix", y.projectionMatrix), ht.setValue(C, "viewMatrix", y.matrixWorldInverse);
          const Vt = ht.map.cameraPosition;
          Vt !== void 0 && Vt.setValue(C, Pe.setFromMatrixPosition(y.matrixWorld)), ze.logarithmicDepthBuffer && ht.setValue(C, "logDepthBufFC", 2 / (Math.log(y.far + 1) / Math.LN2)), (O.isMeshPhongMaterial || O.isMeshToonMaterial || O.isMeshLambertMaterial || O.isMeshBasicMaterial || O.isMeshStandardMaterial || O.isShaderMaterial) && ht.setValue(C, "isOrthographic", y.isOrthographicCamera === true), K !== y && (K = y, Ot = true, Vr = true);
        }
        if (D.isSkinnedMesh) {
        ...
        if ((Gr.position !== void 0 || Gr.normal !== void 0 || Gr.color !== void 0) && we.update(D, F, Kt), (Ot || ye.receiveShadow !== D.receiveShadow) && (ye.receiveShadow = D.receiveShadow, ht.setValue(C, "receiveShadow", D.receiveShadow)), O.isMeshGouraudMaterial && O.envMap !== null && (Rn.envMap.value = ge, Rn.flipEnvMap.value = ge.isCubeTexture && ge.isRenderTargetTexture === false ? -1 : 1), O.isMeshStandardMaterial && O.envMap === null && L.environment !== null && (Rn.envMapIntensity.value = L.environmentIntensity), Ot && (ht.setValue(C, "toneMappingExposure", M.toneMappingExposure), ye.needsLights && Ih(Rn, Vr), ee && O.fog === true && ne.refreshFogUniforms(Rn, ee), ne.refreshMaterialUniforms(Rn, O, Q, z, m.state.transmissionRenderTarget[y.id]), Sr.upload(C, Qa(ye), Rn, T)), O.isShaderMaterial && O.uniformsNeedUpdate === true && (Sr.upload(C, Qa(ye), Rn, T), O.uniformsNeedUpdate = false), O.isSpriteMaterial && ht.setValue(C, "center", D.center), ht.setValue(C, "modelViewMatrix", D.modelViewMatrix), ht.setValue(C, "normalMatrix", D.normalMatrix), ht.setValue(C, "modelMatrix", D.matrixWorld), O.isShaderMaterial || O.isRawShaderMaterial) {
      ...
      this.getActiveCubeFace = function() {
        ...
        if (y) {
          ...
          else if (ge.__webglFramebuffer === void 0) T.setupRenderTarget(y);
          else if (ge.__hasExternalTextures) T.rebindTextures(y, Re.get(y.texture).__webglTexture, Re.get(y.depthTexture).__webglTexture);
          else if (y.depthBuffer) {
            const ve = y.depthTexture;
            if (ge.__boundDepthTexture !== ve) {
              if (ve !== null && Re.has(ve) && (y.width !== ve.image.width || y.height !== ve.image.height)) throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");
        ...
        if (y.isWebGLCubeRenderTarget && se !== void 0 && (fe = fe[se]), fe) {
          ...
          try {
            const ge = y.texture, Me = ge.format, be = ge.type;
        ...
        y.isTexture !== true && (Mr("WebGLRenderer: copyFramebufferToTexture function signature has changed."), L = arguments[0] || null, y = arguments[1]);
        ...
        y.isTexture !== true && (Mr("WebGLRenderer: copyTextureToTexture function signature has changed."), O = arguments[0] || null, y = arguments[1], L = arguments[2], D = arguments[3] || 0, F = null);
        let ee, se, fe, ge, Me, be;
        F !== null ? (ee = F.max.x - F.min.x, se = F.max.y - F.min.y, fe = F.min.x, ge = F.min.y) : (ee = y.image.width, se = y.image.height, fe = 0, ge = 0), O !== null ? (Me = O.x, be = O.y) : (Me = 0, be = 0);
        ...
        const st = C.getParameter(C.UNPACK_ROW_LENGTH), ct = C.getParameter(C.UNPACK_IMAGE_HEIGHT), Ft = C.getParameter(C.UNPACK_SKIP_PIXELS), qe = C.getParameter(C.UNPACK_SKIP_ROWS), ye = C.getParameter(C.UNPACK_SKIP_IMAGES), yt = y.isCompressedTexture ? y.mipmaps[D] : y.image;
        C.pixelStorei(C.UNPACK_ROW_LENGTH, yt.width), C.pixelStorei(C.UNPACK_IMAGE_HEIGHT, yt.height), C.pixelStorei(C.UNPACK_SKIP_PIXELS, fe), C.pixelStorei(C.UNPACK_SKIP_ROWS, ge), y.isDataTexture ? C.texSubImage2D(C.TEXTURE_2D, D, Me, be, ee, se, ve, Ze, yt.data) : y.isCompressedTexture ? C.compressedTexSubImage2D(C.TEXTURE_2D, D, Me, be, yt.width, yt.height, ve, yt.data) : C.texSubImage2D(C.TEXTURE_2D, D, Me, be, ee, se, ve, Ze, yt), C.pixelStorei(C.UNPACK_ROW_LENGTH, st), C.pixelStorei(C.UNPACK_IMAGE_HEIGHT, ct), C.pixelStorei(C.UNPACK_SKIP_PIXELS, Ft), C.pixelStorei(C.UNPACK_SKIP_ROWS, qe), C.pixelStorei(C.UNPACK_SKIP_IMAGES, ye), D === 0 && L.generateMipmaps && C.generateMipmap(C.TEXTURE_2D), Te.unbindTexture();
      }, this.copyTextureToTexture3D = function(y, L, F = null, O = null, D = 0) {
        y.isTexture !== true && (Mr("WebGLRenderer: copyTextureToTexture3D function signature has changed."), F = arguments[0] || null, O = arguments[1] || null, y = arguments[2], L = arguments[3], D = arguments[4] || 0);
        let ee, se, fe, ge, Me, be, ve, Ze, st;
        const ct = y.isCompressedTexture ? y.mipmaps[D] : y.image;
        F !== null ? (ee = F.max.x - F.min.x, se = F.max.y - F.min.y, fe = F.max.z - F.min.z, ge = F.min.x, Me = F.min.y, be = F.min.z) : (ee = ct.width, se = ct.height, fe = ct.depth, ge = 0, Me = 0, be = 0), O !== null ? (ve = O.x, Ze = O.y, st = O.z) : (ve = 0, Ze = 0, st = 0);
        ...
        const yt = C.getParameter(C.UNPACK_ROW_LENGTH), Ke = C.getParameter(C.UNPACK_IMAGE_HEIGHT), Kt = C.getParameter(C.UNPACK_SKIP_PIXELS), ai = C.getParameter(C.UNPACK_SKIP_ROWS), Ot = C.getParameter(C.UNPACK_SKIP_IMAGES);
        C.pixelStorei(C.UNPACK_ROW_LENGTH, ct.width), C.pixelStorei(C.UNPACK_IMAGE_HEIGHT, ct.height), C.pixelStorei(C.UNPACK_SKIP_PIXELS, ge), C.pixelStorei(C.UNPACK_SKIP_ROWS, Me), C.pixelStorei(C.UNPACK_SKIP_IMAGES, be), y.isDataTexture || y.isData3DTexture ? C.texSubImage3D(ye, D, ve, Ze, st, ee, se, fe, Ft, qe, ct.data) : L.isCompressedArrayTexture ? C.compressedTexSubImage3D(ye, D, ve, Ze, st, ee, se, fe, Ft, ct.data) : C.texSubImage3D(ye, D, ve, Ze, st, ee, se, fe, Ft, qe, ct), C.pixelStorei(C.UNPACK_ROW_LENGTH, yt), C.pixelStorei(C.UNPACK_IMAGE_HEIGHT, Ke), C.pixelStorei(C.UNPACK_SKIP_PIXELS, Kt), C.pixelStorei(C.UNPACK_SKIP_ROWS, ai), C.pixelStorei(C.UNPACK_SKIP_IMAGES, Ot), D === 0 && L.generateMipmaps && C.generateMipmap(ye), Te.unbindTexture();
    ...
    set outputColorSpace(e) {
      ...
      t.drawingBufferColorSpace = e === Na ? "display-p3" : "srgb", t.unpackColorSpace = Ge.workingColorSpace === Fr ? "display-p3" : "srgb";
    }
  }
  class n_ extends ot {
    constructor() {
      super(), this.isScene = true, this.type = "Scene", this.background = null, this.environment = null, this.fog = null, this.backgroundBlurriness = 0, this.backgroundIntensity = 1, this.backgroundRotation = new cn(), this.environmentIntensity = 1, this.environmentRotation = new cn(), this.overrideMaterial = null, typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", {
        detail: this
      }));
    }
    copy(e, t) {
  ...
  class ch {
    constructor(e, t) {
      this.isInterleavedBuffer = true, this.array = e, this.stride = t, this.count = e !== void 0 ? e.length / t : 0, this.usage = xa, this.updateRanges = [], this.version = 0, this.uuid = sn();
    }
    onUploadCallback() {
    }
    set needsUpdate(e) {
  ...
  let Si;
  const is = new R(), Ei = new R(), bi = new R(), Ti = new me(), ss = new me(), hh = new Ce(), Qs = new R(), rs = new R(), er = new R(), Zc = new me(), Mo = new me(), Jc = new me();
  class i_ extends ot {
    constructor(e = new lh()) {
      if (super(), this.isSprite = true, this.type = "Sprite", Si === void 0) {
        ...
        Si.setIndex([
          ...
          2,
          3
        ]), Si.setAttribute("position", new Es(n, 3, 0, false)), Si.setAttribute("uv", new Es(n, 2, 3, false));
      }
      this.geometry = Si, this.material = e, this.center = new me(0.5, 0.5);
    }
    raycast(e, t) {
      e.camera === null && console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'), Ei.setFromMatrixScale(this.matrixWorld), hh.copy(e.camera.matrixWorld), this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse, this.matrixWorld), bi.setFromMatrixPosition(this.modelViewMatrix), e.camera.isPerspectiveCamera && this.material.sizeAttenuation === false && Ei.multiplyScalar(-bi.z);
      const n = this.material.rotation;
      let i, r;
      n !== 0 && (r = Math.cos(n), i = Math.sin(n));
      const o = this.center;
      tr(Qs.set(-0.5, -0.5, 0), bi, o, Ei, i, r), tr(rs.set(0.5, -0.5, 0), bi, o, Ei, i, r), tr(er.set(0.5, 0.5, 0), bi, o, Ei, i, r), Zc.set(0, 0), Mo.set(1, 0), Jc.set(1, 1);
      let a = e.ray.intersectTriangle(Qs, rs, er, false, is);
      if (a === null && (tr(rs.set(-0.5, 0.5, 0), bi, o, Ei, i, r), Mo.set(0, 1), a = e.ray.intersectTriangle(Qs, er, rs, false, is), a === null)) return;
      const c = e.ray.origin.distanceTo(is);
      c < e.near || c > e.far || t.push({
        distance: c,
        point: is.clone(),
        uv: Yt.getInterpolation(is, Qs, rs, er, Zc, Mo, Jc, new me()),
        face: null,
        object: this
      });
    }
  ...
  function tr(s, e, t, n, i, r) {
    Ti.subVectors(s, t).addScalar(0.5).multiply(n), i !== void 0 ? (ss.x = r * Ti.x - i * Ti.y, ss.y = i * Ti.x + r * Ti.y) : ss.copy(Ti), s.copy(e), s.x += ss.x, s.y += ss.y, s.applyMatrix4(hh);
  }
  const Qc = new R(), el = new Ye(), tl = new Ye(), s_ = new R(), nl = new Ce(), nr = new R(), So = new hn(), il = new Ce(), Eo = new ws();
  class r_ extends tt {
    constructor(e, t) {
  ...
  class za {
    ...
    fromJSON(e, t) {
      ...
      for (let n = 0, i = e.bones.length; n < i; n++) {
        const r = e.bones[n];
        let o = t[r];
        o === void 0 && (console.warn("THREE.Skeleton: No bone found with UUID:", r), o = new uh()), this.bones.push(o), this.boneInverses.push(new Ce().fromArray(e.boneInverses[n]));
      }
  ...
  const Ai = new Ce(), rl = new Ce(), ir = [], ol = new ln(), a_ = new Ce(), os = new tt(), as = new hn();
  class c_ extends tt {
    constructor(e, t, n) {
    ...
    raycast(e, t) {
      ...
      if (os.geometry = this.geometry, os.material = this.material, os.material !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), as.copy(this.boundingSphere), as.applyMatrix4(n), e.ray.intersectsSphere(as) !== false)) for (let r = 0; r < i; r++) {
        this.getMatrixAt(r, Ai), rl.multiplyMatrices(n, Ai), os.matrixWorld = rl, os.raycast(e, ir);
    ...
    setMorphAt(e, t) {
      ...
      this.morphTexture === null && (this.morphTexture = new dh(new Float32Array(i * this.count), i, this.count, Pa, tn));
  ...
  const Lr = new R(), Dr = new R(), al = new Ce(), cs = new ws(), sr = new hn(), bo = new R(), cl = new R();
  class Br extends ot {
    constructor(e = new _t(), t = new Cs()) {
    ...
    computeLineDistances() {
      ...
      if (e.index === null) {
        ...
        for (let i = 1, r = t.count; i < r; i++) Lr.fromBufferAttribute(t, i - 1), Dr.fromBufferAttribute(t, i), n[i] = n[i - 1], n[i] += Lr.distanceTo(Dr);
    ...
    raycast(e, t) {
      ...
      if (n.boundingSphere === null && n.computeBoundingSphere(), sr.copy(n.boundingSphere), sr.applyMatrix4(i), sr.radius += r, e.ray.intersectsSphere(sr) === false) return;
      ...
      if (h !== null) {
        ...
        for (let _ = f, m = g - 1; _ < m; _ += l) {
          const p = h.getX(_), E = h.getX(_ + 1), M = rr(this, e, cs, c, p, E);
          M && t.push(M);
        }
        if (this.isLineLoop) {
          const _ = h.getX(g - 1), m = h.getX(f), p = rr(this, e, cs, c, _, m);
          p && t.push(p);
        }
      } else {
        const f = Math.max(0, o.start), g = Math.min(d.count, o.start + o.count);
        for (let _ = f, m = g - 1; _ < m; _ += l) {
          const p = rr(this, e, cs, c, _, _ + 1);
          p && t.push(p);
        }
        if (this.isLineLoop) {
          const _ = rr(this, e, cs, c, g - 1, f);
          _ && t.push(_);
        }
      }
    }
  ...
  function rr(s, e, t, n, i, r) {
    const o = s.geometry.attributes.position;
    if (Lr.fromBufferAttribute(o, i), Dr.fromBufferAttribute(o, r), t.distanceSqToSegment(Lr, Dr, bo, cl) > n) return;
    bo.applyMatrix4(s.matrixWorld);
    const c = e.ray.origin.distanceTo(bo);
    if (!(c < e.near || c > e.far)) return {
      distance: c,
      point: cl.clone().applyMatrix4(s.matrixWorld),
      index: i,
      face: null,
      faceIndex: null,
      barycoord: null,
  ...
  const ul = new Ce(), Ma = new ws(), or = new hn(), ar = new R();
  class h_ extends ot {
    constructor(e = new _t(), t = new fh()) {
    ...
    raycast(e, t) {
      ...
      if (l !== null) {
        ...
        for (let g = d, _ = f; g < _; g++) {
          const m = l.getX(g);
          ar.fromBufferAttribute(u, m), dl(ar, m, c, i, e, t, this);
        }
      } else {
        const d = Math.max(0, o.start), f = Math.min(u.count, o.start + o.count);
        for (let g = d, _ = f; g < _; g++) ar.fromBufferAttribute(u, g), dl(ar, g, c, i, e, t, this);
      }
    }
    updateMorphTargets() {
      const t = this.geometry.morphAttributes, n = Object.keys(t);
  ...
  class kr extends _t {
    constructor(e = 1, t = 32, n = 0, i = Math.PI * 2) {
      ...
      const r = [], o = [], a = [], c = [], l = new R(), h = new me();
    ...
    static fromJSON(e) {
      return new kr(e.radius, e.segments, e.thetaStart, e.thetaLength);
    }
  }
  class bs extends _t {
  ...
  class Va extends _t {
    constructor(e = 0.5, t = 1, n = 32, i = 1, r = 0, o = Math.PI * 2) {
      ...
      const a = [], c = [], l = [], h = [];
      let u = e;
      const d = (t - e) / i, f = new R(), g = new me();
      for (let _ = 0; _ <= i; _++) {
        for (let m = 0; m <= n; m++) {
          const p = r + m / n * o;
  ...
  class g_ extends Ps {
    ...
    interpolate_(e, t, n, i) {
      ...
      let l = e * a;
      for (let h = l + a; l !== h; l += 4) Ut.slerpFlat(r, 0, o, l - a, o, l, c);
      return r;
    }
  }
  class Yi extends dn {
  ...
  class Ts {
    ...
    static toJSON(e) {
      ...
      for (let r = 0, o = n.length; r !== o; ++r) t.push(dn.toJSON(n[r]));
      return i;
    }
    ...
    static parseAnimation(e, t) {
      ...
      const n = function(u, d, f, g, _) {
        if (f.length !== 0) {
          const m = [], p = [];
          ph(f, m, p, g), m.length !== 0 && _.push(new u(d, m, p));
        }
      ...
      for (let u = 0; u < l.length; u++) {
        ...
        if (!(!d || d.length === 0)) if (d[0].morphTargets) {
          ...
          n(qi, f + ".position", d, "pos", i), n(Yi, f + ".quaternion", d, "rot", i), n(qi, f + ".scale", d, "scl", i);
        }
      }
  ...
  function x_(s) {
    ...
    if (s.times === void 0) {
      const t = [], n = [];
      ph(s.keys, t, n, "value"), s.times = t, s.values = n;
    }
    ...
    load(e, t, n, i) {
      ...
      fetch(o).then((l) => {
        if (l.status === 200 || l.status === 0) {
          ...
          const h = vn[e], u = l.body.getReader(), d = l.headers.get("X-File-Size") || l.headers.get("Content-Length"), f = d ? parseInt(d) : 0, g = f !== 0;
          let _ = 0;
  ...
  class Wa {
    constructor(e) {
      this.camera = e, this.intensity = 1, this.bias = 0, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new me(512, 512), this.map = null, this.mapPass = null, this.matrix = new Ce(), this.autoUpdate = true, this.needsUpdate = false, this._frustum = new Oa(), this._frameExtents = new me(1, 1), this._viewportCount = 1, this._viewports = [
        new Ye(0, 0, 1, 1)
      ];
    }
    getViewportCount() {
  ...
  class A_ extends Wa {
    constructor() {
      super(new Rt(90, 1, 0.5, 500)), this.isPointLightShadow = true, this._frameExtents = new me(4, 2), this._viewportCount = 6, this._viewports = [
        new Ye(2, 1, 1, 1),
        new Ye(0, 1, 1, 1),
        new Ye(3, 1, 1, 1),
        new Ye(1, 1, 1, 1),
  ...
  const Xa = "\\[\\]\\.:\\/", L_ = new RegExp("[" + Xa + "]", "g"), Ya = "[^" + Xa + "]", D_ = "[^" + Xa.replace("\\.", "") + "]", U_ = /((?:WC+[\/:])*)/.source.replace("WC", Ya), N_ = /(WCOD+)?/.source.replace("WCOD", D_), F_ = /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC", Ya), O_ = /\.(WC+)(?:\[(.+)\])?/.source.replace("WC", Ya), B_ = new RegExp("^" + U_ + N_ + F_ + O_ + "$"), k_ = [
    "material",
    "materials",
    "bones",
    "map"
  ...
  class H_ {
    ...
    _setEndings(e, t, n) {
      ...
      n ? (i.endingStart = Ci, i.endingEnd = Ci) : (e ? i.endingStart = this.zeroSlopeAtStart ? Ci : Ri : i.endingStart = wr, t ? i.endingEnd = this.zeroSlopeAtEnd ? Ci : Ri : i.endingEnd = wr);
    }
  ...
  class G_ extends Xn {
    ...
    _lendControlInterpolant() {
      ...
      let n = e[t];
      return n === void 0 && (n = new mh(new Float32Array(2), new Float32Array(2), 1, V_), n.__cacheIndex = t, e[t] = n), n;
    }
  ...
  const Nn = new R(), lr = new Ce(), wo = new Ce();
  class W_ extends Ha {
    constructor(e) {
      const t = vh(e), n = new _t(), i = [], r = [], o = new Se(0, 0, 1), a = new Se(0, 1, 0);
    ...
    updateMatrixWorld(e) {
      ...
      for (let r = 0, o = 0; r < t.length; r++) {
        const a = t[r];
        a.parent && a.parent.isBone && (lr.multiplyMatrices(wo, a.matrixWorld), Nn.setFromMatrixPosition(lr), i.setXYZ(o, Nn.x, Nn.y, Nn.z), lr.multiplyMatrices(wo, a.parent.matrixWorld), Nn.setFromMatrixPosition(lr), i.setXYZ(o + 1, Nn.x, Nn.y, Nn.z), o += 2);
      }
  ...
  function vh(s) {
    ...
    for (let t = 0; t < s.children.length; t++) e.push.apply(e, vh(s.children[t]));
    return e;
  }
  const hr = new ln();
  class X_ extends Ha {
    constructor(e, t = 16776960) {
      const n = new Uint16Array([
        ...
        3,
        7
      ]), i = new Float32Array(8 * 3), r = new _t();
      r.setIndex(new vt(n, 1)), r.setAttribute("position", new vt(i, 3)), super(r, new Cs({
        color: t,
        toneMapped: false
      })), this.object = e, this.type = "BoxHelper", this.matrixAutoUpdate = false, this.update();
    }
    update(e) {
      if (e !== void 0 && console.warn("THREE.BoxHelper: .update() has no longer arguments."), this.object !== void 0 && hr.setFromObject(this.object), hr.isEmpty()) return;
      const t = hr.min, n = hr.max, i = this.geometry.attributes.position, r = i.array;
  ...
  function q_() {
    const s = new nn(), { W: e, H: t } = Ur.FIELD, n = new tt(new si(e, t), new wn({
      color: 2981184,
      roughness: 1
    }));
    n.rotation.x = -Math.PI / 2, n.receiveShadow = true, s.add(n);
    const i = 6e-3, r = (d, f, g, _, m = lt.LINE) => {
      const p = g - d, E = _ - f, M = Math.hypot(p, E), b = new si(M, m), I = new Ht({
        color: 16777215
      }), A = new tt(b, I);
    ...
    const o = (d, f, g, _, m = 0, p = Math.PI * 2, E = false) => {
      const M = 6e-3 + (E ? 1e-4 : 0), b = new Va(g, _, 64, 1, m, p), I = new Ht({
        color: 16777215,
        side: Xt
      }), A = new tt(b, I);
      return A.position.set(d, M, f), A.rotation.x = -Math.PI / 2, A.renderOrder = 2, s.add(A), A;
    }, a = (d, f, g) => {
      const _ = new kr(g, 24), m = new Ht({
        color: 16777215
      }), p = new tt(_, m);
    ...
    const c = (d, f, g, _) => {
      ...
      const m = g - d, p = _ - f, E = Math.hypot(m, p), M = new si(E, lt.LINE), b = new Ht({
        color: 16777215
      }), I = new tt(M, b);
  ...
  function K_(s) {
    const { W: e } = Ur.FIELD, t = Ur.GOAL, n = 0.06, i = (r) => {
      const o = r * (e / 2 + n), a = new nn(), c = new bs(n, n, t.H, 8), l = new wn({
        color: 16777215,
        roughness: 0.4
  ...
  class j_ {
    constructor() {
      ...
      const e = new Ga(Ur.BALL.R, 16, 16), t = new wn({
        color: 16777215
      });
...
FPS: ${t.toFixed(1)}`;
  ...
  class yh extends Zi {
    ...
    parse(e, t, n, i) {
      ...
      else if (e instanceof ArrayBuffer) if (c.decode(new Uint8Array(e, 0, 4)) === Mh) {
        try {
  ...
  class J_ {
    ...
    _loadLight(e) {
      ...
      switch (c.type) {
        case "directional":
          l = new xh(h), l.target.position.set(0, 0, -1), l.add(l.target);
          break;
        case "point":
  ...
  class mx {
    ...
    createNodeMesh(e) {
      ...
      return a.length < 1 ? null : (a.push(this.parser.createNodeMesh(e)), Promise.all(a).then((l) => {
        ...
        for (const g of u) {
          const _ = new Ce(), m = new R(), p = new Ut(), E = new R(1, 1, 1), M = new c_(g.geometry, g.material, d);
          ...
          for (const b in c) if (b === "_COLOR_0") {
            const I = c[b];
            M.instanceColor = new ya(I.array, I.itemSize, I.normalized);
  ...
  class gx {
    constructor(e) {
      ...
      }, this.header.magic !== Mh) throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");
  ...
  class Cx {
    constructor(e = {}, t = {}) {
      this.json = e, this.extensions = {}, this.plugins = {}, this.options = t, this.cache = new Z_(), this.associations = /* @__PURE__ */ new Map(), this.primitiveCache = {}, this.nodeCache = {}, this.meshCache = {
        refs: {},
        uses: {}
      }, this.cameraCache = {
        refs: {},
      ...
      typeof createImageBitmap > "u" || n && i < 17 || r && o < 98 ? this.textureLoader = new E_(this.options.manager) : this.textureLoader = new P_(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new _h(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(true);
    }
    setExtensions(e) {
      this.extensions = e;
    }
    ...
    parse(e, t) {
      ...
      this.cache.removeAll(), this.nodeCache = {}, this._invokeAll(function(o) {
        ...
        return Qn(r, a, i), Sn(a, i), Promise.all(n._invokeAll(function(c) {
    ...
    loadAccessor(e) {
      ...
      return i.bufferView !== void 0 ? r.push(this.getDependency("bufferView", i.bufferView)) : r.push(null), i.sparse !== void 0 && (r.push(this.getDependency("bufferView", i.sparse.indices.bufferView)), r.push(this.getDependency("bufferView", i.sparse.values.bufferView))), Promise.all(r).then(function(o) {
        ...
        if (f && f !== u) {
          ...
          let M = t.cache.get(E);
          M || (_ = new l(a, p * f, i.count * f / h), M = new ch(_, f / h), t.cache.add(E, M)), m = new Es(M, c, d % f / h, g);
        } else a === null ? _ = new l(i.count * c) : _ = new l(a, d, i.count * c), m = new vt(_, c, g);
        if (i.sparse !== void 0) {
          const p = Ro.SCALAR, E = Fi[i.sparse.indices.componentType], M = i.sparse.indices.byteOffset || 0, b = i.sparse.values.byteOffset || 0, I = new E(o[1], M, i.sparse.count * p), A = new l(o[2], b, i.sparse.count * c);
    ...
    loadTextureImage(e, t, n) {
      ...
      const l = this.loadImageSource(t, n).then(function(h) {
        ...
        return h.magFilter = yl[d.magFilter] || zt, h.minFilter = yl[d.minFilter] || En, h.wrapS = Ml[d.wrapS] || zi, h.wrapT = Ml[d.wrapT] || zi, i.associations.set(h, {
          textures: e
        }), h;
      }).catch(function() {
        return null;
    ...
    loadImageSource(e, t) {
      ...
      const h = Promise.resolve(c).then(function(u) {
        ...
        return l === true && a.revokeObjectURL(c), Sn(u, o), u.userData.mimeType = o.mimeType || wx(o.uri), u;
      }).catch(function(u) {
    ...
    assignFinalMaterial(e) {
      ...
      if (e.isPoints) {
        ...
        c || (c = new fh(), rn.prototype.copy.call(c, n), c.color.copy(n.color), c.map = n.map, c.sizeAttenuation = false, this.cache.add(a, c)), n = c;
      } else if (e.isLine) {
        const a = "LineBasicMaterial:" + n.uuid;
        let c = this.cache.get(a);
        c || (c = new Cs(), rn.prototype.copy.call(c, n), c.color.copy(n.color), c.map = n.map, this.cache.add(a, c)), n = c;
      }
      if (i || r || o) {
    ...
    loadMaterial(e) {
      ...
      if (h === Co.BLEND ? (a.transparent = true, a.depthWrite = false) : (a.transparent = false, h === Co.MASK && (a.alphaTest = r.alphaCutoff !== void 0 ? r.alphaCutoff : 0.5)), r.normalTexture !== void 0 && o !== Ht && (l.push(t.assignTexture(a, "normalMap", r.normalTexture)), a.normalScale = new me(1, 1), r.normalTexture.scale !== void 0)) {
        const u = r.normalTexture.scale;
        a.normalScale.set(u, u);
      }
      if (r.occlusionTexture !== void 0 && o !== Ht && (l.push(t.assignTexture(a, "aoMap", r.occlusionTexture)), r.occlusionTexture.strength !== void 0 && (a.aoMapIntensity = r.occlusionTexture.strength)), r.emissiveFactor !== void 0 && o !== Ht) {
        const u = r.emissiveFactor;
        a.emissive = new Se().setRGB(u[0], u[1], u[2], St);
      }
      return r.emissiveTexture !== void 0 && o !== Ht && l.push(t.assignTexture(a, "emissiveMap", r.emissiveTexture, wt)), Promise.all(l).then(function() {
        const u = new o(a);
        return r.name && (u.name = r.name), Sn(u, r), t.associations.set(u, {
          materials: e
        }), r.extensions && Qn(i, u, r), u;
      });
    }
    createUniqueName(e) {
    ...
    loadGeometries(e) {
      ...
      for (let a = 0, c = e.length; a < c; a++) {
        ...
        if (u) o.push(u.promise);
          ...
          let d;
          l.extensions && l.extensions[Ue.KHR_DRACO_MESH_COMPRESSION] ? d = r(l) : d = Sl(new _t(), l, t), i[h] = {
            primitive: l,
            promise: d
          }, o.push(d);
        }
    ...
    loadMesh(e) {
      ...
      return a.push(t.loadGeometries(o)), Promise.all(a).then(function(c) {
        ...
        for (let f = 0, g = h.length; f < g; f++) {
          ...
          let p;
          const E = l[f];
          if (m.mode === Wt.TRIANGLES || m.mode === Wt.TRIANGLE_STRIP || m.mode === Wt.TRIANGLE_FAN || m.mode === void 0) p = r.isSkinnedMesh === true ? new r_(_, E) : new tt(_, E), p.isSkinnedMesh === true && p.normalizeSkinWeights(), m.mode === Wt.TRIANGLE_STRIP ? p.geometry = xl(p.geometry, Gl) : m.mode === Wt.TRIANGLE_FAN && (p.geometry = xl(p.geometry, _a));
          else if (m.mode === Wt.LINES) p = new Ha(_, E);
          else if (m.mode === Wt.LINE_STRIP) p = new Br(_, E);
          ...
          Object.keys(p.geometry.morphAttributes).length > 0 && Tx(p, r), p.name = t.createUniqueName(r.name || "mesh_" + e), Sn(p, r), m.extensions && Qn(i, p, m), t.assignFinalMaterial(p), u.push(p);
        }
        ...
        const d = new nn();
        r.extensions && Qn(i, d, r), t.associations.set(d, {
          meshes: e
        });
    ...
    loadCamera(e) {
      ...
      return n.type === "perspective" ? t = new Rt(Qt.radToDeg(i.yfov), i.aspectRatio || 1, i.znear || 1, i.zfar || 2e6) : n.type === "orthographic" && (t = new Ba(-i.xmag, i.xmag, i.ymag, -i.ymag, i.znear, i.zfar)), n.name && (t.name = this.createUniqueName(n.name)), Sn(t, n), Promise.resolve(t);
    }
    loadSkin(e) {
    ...
    _loadNodeShallow(e) {
      ...
      return c && a.push(c), r.camera !== void 0 && a.push(i.getDependency("camera", r.camera).then(function(l) {
        ...
        let h;
        if (r.isBone === true ? h = new uh() : l.length > 1 ? h = new nn() : l.length === 1 ? h = l[0] : h = new ot(), h !== l[0]) for (let u = 0, d = l.length; u < d; u++) h.add(l[u]);
        if (r.name && (h.userData.name = r.name, h.name = o), Sn(h, r), r.extensions && Qn(n, h, r), r.matrix !== void 0) {
          const u = new Ce();
    ...
    loadScene(e) {
      const t = this.extensions, n = this.json.scenes[e], i = this, r = new nn();
      n.name && (r.name = i.createUniqueName(n.name)), Sn(r, n), n.extensions && Qn(t, r, n);
      const o = n.nodes || [], a = [];
      ...
      return Promise.all(a).then(function(c) {
        ...
        const l = (h) => {
          ...
          for (const [d, f] of i.associations) (d instanceof rn || d instanceof pt) && u.set(d, f);
          return h.traverse((d) => {
    ...
    _createCubicSplineTrackInterpolant(e) {
      e.createInterpolant = function(n) {
        const i = this instanceof Yi ? Mx : Sh;
  ...
  function Sl(s, e, t) {
    ...
    return Ge.workingColorSpace !== St && "COLOR_0" in n && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Ge.workingColorSpace}" not supported.`), Sn(s, e), Px(s, e, t), Promise.all(i).then(function() {
      return e.targets !== void 0 ? bx(s, e.targets, t) : s;
    });
  }
  function Ix(s) {
    const e = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Map(), n = s.clone();
    return Eh(s, n, function(i, r) {
      e.set(r, i), t.set(i, r);
  ...
  function Eh(s, e, t) {
    t(s, e);
    for (let n = 0; n < s.children.length; n++) Eh(s.children[n], e.children[n], t);
  }
  ...
  async function Dx(s = "/assets/player.glb") {
    ...
    const n = (await new yh().loadAsync(s)).scene;
    n.traverse((r) => {
      const o = r;
      if (o.isMesh && (o.castShadow = true, o.receiveShadow = true, !(o.material instanceof wn))) {
        const a = new wn({
          color: 16777215
        });
  ...
  function Ux(s, e) {
    ...
    const r = new bs(0.25, 0.25, 1.8, 16), o = new wn({
      color: 16777215
    }), a = new tt(r, o);
    ...
    return bh(h, e === 0 ? 2062260 : 14034728), t.traverse((u) => {
  ...
  function Ox(s) {
    ...
    return s.traverse((t) => {
      t.isBone && t.name && e.set(Th(t.name), t.name);
    }), e;
  }
  function Bx(s, e) {
    const t = Ox(e), n = s.tracks.map((i) => {
      const r = /^([^.]*)\.(.*)$/.exec(i.name);
      if (!r) return i;
      const [, o, a] = r, c = Th(o), l = t.get(c);
      if (!l || l === o) return i;
  ...
  async function Hx({ loader: s, mixer: e, model: t, clipSources: n, policy: i }) {
    var _a2;
    ...
    for (const [a, c] of r) {
      ...
      h.name = a, h = Bx(h, t), (i ? i(a) : Gx(a)) === "inplace" && (h = kx(h, {
        removeRootPos: true
      })), zx(t, h);
  ...
  class Wx {
    constructor() {
      __publicField(this, "group", new nn());
    ...
    destroy() {
      for (const e of this.inst) this.group.remove(e.root), e.targetMarker && (this.group.remove(e.targetMarker), e.targetMarker = void 0);
    ...
    async init(e = 22, t) {
      ...
      this.modelUrl = n;
      const i = await Dx(n), r = new yh();
      this.lockUntil = new Array(e).fill(0), this.isPlayerMoving = new Array(e).fill(false), this.playerIndexMap = Array.from({
        length: e
      }, (o, a) => a);
      for (let o = 0; o < e; o++) {
        const a = Ux(i, o < 11 ? 0 : 1), c = await Hx({
          loader: r,
          mixer: a.mixer,
          model: a.root,
          clipSources: yn.clipUrls
        }), { idle: l, walk: h, run: u } = yn.locomotionMap;
        c[l] && c[l].setEffectiveWeight(1).play(), c[h] && c[h].setEffectiveWeight(0).play(), c[u] && c[u].setEffectiveWeight(0).play(), Object.values(yn.eventMap).forEach((d) => {
          const f = c[d.name];
          f && (f.setLoop(Vl, 0), f.clampWhenFinished = true, f.enabled = true, f.setEffectiveWeight(0), f.play());
    ...
    update(e, t) {
      if (this.ready) for (let n = 0; n < this.inst.length; n++) {
        ...
        if (!r || !o || !a) continue;
        Nx(o, r);
        const c = r.speed ?? 0, l = Qt.clamp(c, 0, 7), { idle: h, walk: u, run: d } = yn.locomotionMap, _ = Qt.smoothstep(l, 1, 4), m = 1 - _;
        ...
        o.mixer.update(t), this.updateTargetMarker(i);
      }
    }
    setMoveTarget(e, t, n) {
      t ? this.moveTargets.set(e, t.clone()) : this.moveTargets.delete(e), this.updateTargetMarker(e, n);
    }
    ...
    createTargetMarker() {
      const e = new kr(0.6, 24);
      e.rotateX(-Math.PI / 2);
      const t = new Ht({
        color: 16763955,
        transparent: true,
        opacity: 0.5
      }), n = new tt(e, t), i = new Cs({
        color: 16755200
      }), r = new _t().setFromPoints([
        new R(0, 0, 0),
        new R(0, 0, 1.2),
        new R(0.25, 0, 0.9),
        new R(-0.25, 0, 0.9)
      ]), o = new Br(r, i), a = new nn();
      return a.add(n), a.add(o), a.visible = false, a.position.y = 0.05, a;
    }
    setPlayerIndex(e, t) {
      !Number.isInteger(e) || e < 0 || e >= this.playerIndexMap.length || Number.isInteger(t) && (this.playerIndexMap[e] = t, this.refreshMoveTargetMarkers());
    }
    resetPlayerIndexMap() {
      this.playerIndexMap = Array.from({
        length: this.inst.length
      }, (e, t) => t), this.refreshMoveTargetMarkers();
    }
    applyEvents(e) {
      if (!(!this.ready || !e)) for (const t of e) {
        const n = yn.eventMap[t.kind];
    ...
    playOneShot(e, t, n) {
      ...
      if (!o) return;
      if (t === "KickL" || t === "KickR") {
        const l = r[yn.eventMap.KickL.name], h = r[yn.eventMap.KickR.name];
    ...
    getCurrentActionName(e) {
      const t = this.ctrl[e];
      if (!t) return "UNKNOWN";
      for (const u of Object.values(yn.eventMap)) {
        const d = t[u.name];
        if (d && d.isRunning() && d.getEffectiveWeight() > 0.5) return u.name.toUpperCase();
      }
      let n = 0, i = "IDLE";
      const { idle: r, walk: o, run: a } = yn.locomotionMap, c = t[r];
      if (c) {
  ...
  let Er = typeof TextDecoder < "u" ? new TextDecoder("utf-8", {
    ignoreBOM: true,
    fatal: true
  }) : {
    decode: () => {
  ...
  let Lo = 0;
  function Yx(s, e) {
    return Lo += e, Lo >= Xx && (Er = typeof TextDecoder < "u" ? new TextDecoder("utf-8", {
      ignoreBOM: true,
      fatal: true
    }) : {
      decode: () => {
    ...
    }, Er.decode(), Lo = e), Er.decode(xs().subarray(s, s + e));
  }
  function ps(s, e) {
    return s = s >>> 0, Yx(s, e);
  }
  let Ii = 0;
  const br = typeof TextEncoder < "u" ? new TextEncoder("utf-8") : {
    encode: () => {
      throw Error("TextEncoder not available");
    }
  }, qx = typeof br.encodeInto == "function" ? function(s, e) {
    return br.encodeInto(s, e);
  } : function(s, e) {
    const t = br.encode(s);
    return e.set(t), {
      read: s.length,
  ...
  function ur(s, e, t) {
    if (t === void 0) {
      const a = br.encode(s), c = e(a.length, 1) >>> 0;
    ...
    if (o !== n) {
      ...
      const a = xs().subarray(i + o, i + n), c = qx(s, a);
...
${s.stack}` : n;
  ...
  async function $x(s, e) {
    if (typeof Response == "function" && s instanceof Response) {
      if (typeof WebAssembly.instantiateStreaming == "function") try {
        ...
        if (s.ok && jx.has(s.type) && s.headers.get("Content-Type") !== "application/wasm") console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n", n);
        else throw n;
      }
  ...
  function Zx() {
    ...
    return s.wbg = {}, s.wbg.__wbg_Error_1f3748b298f99708 = function(e, t) {
      ...
      const n = String(t), i = ur(n, Ve.__wbindgen_malloc, Ve.__wbindgen_realloc), r = Ii;
      on().setInt32(e + 4 * 1, r, true), on().setInt32(e + 4 * 0, i, true);
      ...
      Uint8Array.prototype.set.call(Tr(e, t), n);
    }, s.wbg.__wbg_stack_0ed75d68575b0f3c = function(e, t) {
      const n = t.stack, i = ur(n, Ve.__wbindgen_malloc, Ve.__wbindgen_realloc), r = Ii;
      on().setInt32(e + 4 * 1, r, true), on().setInt32(e + 4 * 0, i, true);
      ...
      return dr(n) ? 16777215 : n ? 1 : 0;
    }, s.wbg.__wbg_wbindgendebugstring_bb652b1bc2061b6d = function(e, t) {
      const n = ba(t), i = ur(n, Ve.__wbindgen_malloc, Ve.__wbindgen_realloc), r = Ii;
      on().setInt32(e + 4 * 1, r, true), on().setInt32(e + 4 * 0, i, true);
      ...
      on().setFloat64(e + 8 * 1, dr(i) ? 0 : i, true), on().setInt32(e + 4 * 0, !dr(i), true);
    }, s.wbg.__wbg_wbindgenstringget_43fe05afe34b0cb1 = function(e, t) {
      const n = t, i = typeof n == "string" ? n : void 0;
      var r = dr(i) ? 0 : ur(i, Ve.__wbindgen_malloc, Ve.__wbindgen_realloc), o = Ii;
      on().setInt32(e + 4 * 1, o, true), on().setInt32(e + 4 * 0, r, true);
  ...
  function Jx(s, e) {
    return Ve = s.exports, Ah.__wbindgen_wasm_module = e, ti = null, fs = null, Ve.__wbindgen_start(), Ve;
  }
  async function Ah(s) {
    if (Ve !== void 0) return Ve;
    typeof s < "u" && (Object.getPrototypeOf(s) === Object.prototype ? { module_or_path: s } = s : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), typeof s > "u" && (s = new URL("/assets/engine_bg-8OsaYBub.wasm", import.meta.url));
    const e = Zx();
    (typeof s == "string" || typeof Request == "function" && s instanceof Request || typeof URL == "function" && s instanceof URL) && (s = fetch(s));
    const { instance: t, module: n } = await $x(await s, e);
    return Jx(t, n);
  }
  const bl = 2, Qx = 32, Ta = 22, Tl = 20 + Ta * Qx;
  function e0(s) {
  ...
  const Al = {
    ...
    type: "end"
  }, fr = new ws(), wl = new Bn(), n0 = Math.cos(70 * Qt.DEG2RAD), ft = new R(), Lt = 2 * Math.PI, et = {
    NONE: -1,
    ROTATE: 0,
    DOLLY: 1,
    PAN: 2,
  ...
  class i0 extends Y_ {
    constructor(e, t = null) {
      super(e, t), this.state = et.NONE, this.enabled = true, this.target = new R(), this.cursor = new R(), this.minDistance = 0, this.maxDistance = 1 / 0, this.minZoom = 0, this.maxZoom = 1 / 0, this.minTargetRadius = 0, this.maxTargetRadius = 1 / 0, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -1 / 0, this.maxAzimuthAngle = 1 / 0, this.enableDamping = false, this.dampingFactor = 0.05, this.enableZoom = true, this.zoomSpeed = 1, this.enableRotate = true, this.rotateSpeed = 1, this.enablePan = true, this.panSpeed = 1, this.screenSpacePanning = true, this.keyPanSpeed = 7, this.zoomToCursor = false, this.autoRotate = false, this.autoRotateSpeed = 2, this.keys = {
        ...
        ONE: wi.ROTATE,
        TWO: wi.DOLLY_PAN
      }, this.target0 = this.target.clone(), this.position0 = this.object.position.clone(), this.zoom0 = this.object.zoom, this._domElementKeyEvents = null, this._lastPosition = new R(), this._lastQuaternion = new Ut(), this._lastTargetPosition = new R(), this._quat = new Ut().setFromUnitVectors(e.up, new R(0, 1, 0)), this._quatInverse = this._quat.clone().invert(), this._spherical = new _l(), this._sphericalDelta = new _l(), this._scale = 1, this._panOffset = new R(), this._rotateStart = new me(), this._rotateEnd = new me(), this._rotateDelta = new me(), this._panStart = new me(), this._panEnd = new me(), this._panDelta = new me(), this._dollyStart = new me(), this._dollyEnd = new me(), this._dollyDelta = new me(), this._dollyDirection = new R(), this._mouse = new me(), this._performCursorZoom = false, this._pointers = [], this._pointerPositions = {}, this._controlActive = false, this._onPointerMove = r0.bind(this), this._onPointerDown = s0.bind(this), this._onPointerUp = o0.bind(this), this._onContextMenu = f0.bind(this), this._onMouseWheel = l0.bind(this), this._onKeyDown = h0.bind(this), this._onTouchStart = u0.bind(this), this._onTouchMove = d0.bind(this), this._onMouseDown = a0.bind(this), this._onMouseMove = c0.bind(this), this._interceptControlDown = p0.bind(this), this._interceptControlUp = m0.bind(this), this.domElement !== null && this.connect(), this.update();
    }
    connect() {
    ...
    reset() {
      this.target.copy(this.target0), this.object.position.copy(this.position0), this.object.zoom = this.zoom0, this.object.updateProjectionMatrix(), this.dispatchEvent(Al), this.update(), this.state = et.NONE;
    }
    update(e = null) {
      const t = this.object.position;
      ft.copy(t).sub(this.target), ft.applyQuaternion(this._quat), this._spherical.setFromVector3(ft), this.autoRotate && this.state === et.NONE && this._rotateLeft(this._getAutoRotationAngle(e)), this.enableDamping ? (this._spherical.theta += this._sphericalDelta.theta * this.dampingFactor, this._spherical.phi += this._sphericalDelta.phi * this.dampingFactor) : (this._spherical.theta += this._sphericalDelta.theta, this._spherical.phi += this._sphericalDelta.phi);
      ...
      if (ft.setFromSpherical(this._spherical), ft.applyQuaternion(this._quatInverse), t.copy(this.target).add(ft), this.object.lookAt(this.target), this.enableDamping === true ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
        ...
        o !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(o).add(this.object.position) : (fr.origin.copy(this.object.position), fr.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(fr.direction)) < n0 ? this.object.lookAt(this.target) : (wl.setFromNormalAndCoplanarPoint(this.object.up, this.target), fr.intersectPlane(wl, this.target))));
      } else if (this.object.isOrthographicCamera) {
  ...
  function o0(s) {
    switch (this._removePointer(s), this._pointers.length) {
      case 0:
        this.domElement.releasePointerCapture(s.pointerId), this.domElement.removeEventListener("pointermove", this._onPointerMove), this.domElement.removeEventListener("pointerup", this._onPointerUp), this.dispatchEvent(wh), this.state = et.NONE;
        break;
      case 1:
  ...
  function a0(s) {
    ...
    this.state !== et.NONE && this.dispatchEvent(qa);
  }
  function c0(s) {
    switch (this.state) {
      case et.ROTATE:
  ...
  function l0(s) {
    this.enabled === false || this.enableZoom === false || this.state !== et.NONE || (s.preventDefault(), this.dispatchEvent(qa), this._handleMouseWheel(this._customWheelEvent(s)), this.dispatchEvent(wh));
  }
  function h0(s) {
  ...
  function g0(s) {
    ...
    const i = new i0(t, n.domElement);
    i.target.set(0, 0, 0), i.enableDamping = true;
    const r = new C_(16777215, 0.8);
    e.add(r);
    const o = new xh(16777215, 1.2);
    return o.position.set(-100, 100, 50), o.castShadow = true, e.add(o), {
      scene: e,
      camera: t,
      renderer: n,
      controls: i
  ...
  const Jt = 22, pr = 1 / 20, Rl = "/assets/player.glb", On = 1, _0 = 0.6;
  function x0() {
    const s = Array.from({
      length: Jt
    }, (e, t) => ({
  ...
  class v0 {
    constructor(e, t = document) {
      __publicField(this, "source", t0());
      __publicField(this, "players", new Wx());
      ...
      __publicField(this, "playerSpeeds", new Float32Array(Jt));
      __publicField(this, "ui");
      __publicField(this, "debugHotkeys", []);
      __publicField(this, "generalDebugHotkeys", [
        {
          label: "Space",
          description: "Toggle Pause"
        }
      ]);
      __publicField(this, "prev", x0());
      ...
      __publicField(this, "onFrame", () => {
        ...
        if (this.last = e, this.isDriveMode ? this.updateDriveMode() : this.updateCameraPosition(), !this.isPaused) for (this.acc += t; this.acc >= pr; ) this.stepSimulation(), this.acc -= pr;
        const n = this.isPaused ? 1 : this.acc / pr, i = this.interpolatePlayers(n);
        if (this.players.update(i, t), this.ball.update({
          x: Qt.lerp(this.prev.ball.x, this.curr.ball.x, n),
          y: Qt.lerp(this.prev.ball.y, this.curr.ball.y, n),
          z: Qt.lerp(this.prev.ball.z, this.curr.ball.z, n)
        }), t > 0) {
          const r = 1 / t;
      ...
      __publicField(this, "handleProfileChange", () => {
        ...
        Number.isNaN(t) || (this.currentPlayerCount < Jt && (this.selectedProfileIndex != null && this.source.engine.set_ai_active(this.selectedProfileIndex, false), this.source.engine.set_ai_active(t, true)), this.setSelectedProfileIndex(t, false));
      });
      var _a2, _b;
      this.mount = e, this.doc = t, this.ui = this.resolveUIElements(), this.currentModelUrl = ((_b = (_a2 = this.ui.playerModelInput) == null ? void 0 : _a2.value) == null ? void 0 : _b.trim()) || Rl, this.debugHotkeys = this.createDebugHotkeys();
    }
    async init() {
      this.sceneContext = g0(this.mount), this.last = performance.now() / 1e3, this.sceneContext.scene.add(q_()), this.sceneContext.scene.add(this.ball.mesh), this.sceneContext.scene.add(this.players.group), this.bindUIEvents(), this.bindGlobalEvents(), await this.source.ready(), this.playerProfiles = this.source.getPlayerProfiles(), this.populatePlayerProfileSelect();
      const e = this.getRequestedPlayerCount();
      await this.players.init(e, this.currentModelUrl), this.currentPlayerCount = e, this.syncAiActive(e), this.players.setTeamColor(0, 2062260), this.players.setTeamColor(1, 14034728), this.prev = this.source.get(), this.curr = this.prev, this.updateUIMode(e), this.ensureSelectedProfile(), this.updatePlayerIndexMapping(), this.renderDebugInfoPanel();
    }
    start() {
    ...
    interpolatePlayers(e) {
      return this.curr.players.map((t, n) => {
        ...
        if (!i) return t;
        const r = Qt.lerp(i.h[0], t.h[0], e), o = Qt.lerp(i.h[1], t.h[1], e), a = Math.hypot(r, o) || 1;
        return {
          ...t,
          x: Qt.lerp(i.x, t.x, e),
          y: Qt.lerp(i.y, t.y, e),
    ...
    updatePlayerSpeeds() {
      for (let e = 0; e < this.curr.players.length; e++) {
        ...
        this.playerSpeeds[e] = Math.hypot(i, r) / pr;
      }
    }
    updateDriveMode() {
      if (!this.isDriveMode || this.selectedProfileIndex == null) return;
      const e = this.curr.players[this.selectedProfileIndex], t = this.playerProfiles[this.selectedProfileIndex];
      if (!e || !t) return;
      const n = t.pace * 0.1, i = (this.keyboardState.KeyW ? 1 : 0) + (this.keyboardState.KeyS ? -1 : 0), r = (this.keyboardState.KeyD ? 1 : 0) + (this.keyboardState.KeyA ? -1 : 0), o = new me(e.h[0], e.h[1]);
      o.lengthSq() < 1e-6 ? o.set(0, 1) : o.normalize();
      const a = new me(-o.y, o.x), c = new me(0, 0).add(o.clone().multiplyScalar(i)).add(a.clone().multiplyScalar(r)), l = new me(e.x, e.y);
      let h = l.clone(), u = null;
      if (c.lengthSq() > 0) {
        u = c.clone().normalize();
        const m = Math.max(n * _0, 2);
      ...
      f.applyQuaternion(new Ut().setFromAxisAngle(new R(0, 1, 0), g));
    ...
    updateCameraPosition() {
      ...
      this.keyboardState.KeyW && (this.sceneContext.camera.position.addScaledVector(e, On), this.sceneContext.controls.target.addScaledVector(e, On)), this.keyboardState.KeyS && (this.sceneContext.camera.position.addScaledVector(e, -On), this.sceneContext.controls.target.addScaledVector(e, -On)), this.keyboardState.KeyA && (this.sceneContext.camera.position.addScaledVector(t, On), this.sceneContext.controls.target.addScaledVector(t, On)), this.keyboardState.KeyD && (this.sceneContext.camera.position.addScaledVector(t, -On), this.sceneContext.controls.target.addScaledVector(t, -On));
    }
    bindUIEvents() {
      var _a2, _b, _c2, _d2;
    ...
    async restartPlayerSystem(e) {
      ...
      const t = this.getRequestedPlayerCount(), n = this.players.getModelUrl(), i = (e ?? this.currentModelUrl).trim() || Rl;
    ...
    updatePlayerIndexMapping() {
      this.players.ready && (this.players.resetPlayerIndexMap(), this.currentPlayerCount < Jt && this.selectedProfileIndex != null && this.players.setPlayerIndex(0, this.selectedProfileIndex));
    }
    syncAiActive(e) {
      for (let t = 0; t < Jt; t++) this.source.engine.set_ai_active(t, t < e);
    }
    ...
    setSelectedProfileIndex(e, t = true) {
      ...
      this.selectedProfileIndex = e, t && this.ui.playerProfileSelect && (this.ui.playerProfileSelect.value = e != null ? e.toString() : ""), n != null && n !== e && this.players.setMoveTarget(n, null), e != null && (this.driveTarget ? this.players.setMoveTarget(e, new R(this.driveTarget.x, 0, this.driveTarget.y)) : this.players.setMoveTarget(e, null)), this.updatePlayerIndexMapping(), this.renderDebugInfoPanel();
    }
    ...
    renderDebugInfoPanel() {
      ...
      const t = this.playerProfiles[this.selectedProfileIndex], n = t ? t.team === 0 ? "Home" : "Away" : "", i = t ? t.foot === "L" ? "Left" : "Right" : "", r = this.debugHotkeys.filter((h) => h.showInPanel !== false).filter((h) => !h.condition || h.condition()).map((h) => ({
        label: h.keyLabel,
        description: h.description
      })), o = [
        ...this.generalDebugHotkeys,
        ...r
      ].map((h) => `<div class="hotkey-line"><span class="hotkey-key">${h.label}</span><span>${h.description}</span></div>`).join(""), a = this.driveTarget, c = t ? `
    ...
    createDebugHotkeys() {
      return [
        ...
        },
        {
          ...
          suppressRepeat: true,
          condition: () => this.currentPlayerCount < Jt && this.selectedProfileIndex != null
        },
        {
          code: "Digit1",
          keyLabel: "1",
        ...
        },
        {
          ...
          suppressRepeat: true,
          condition: () => this.currentPlayerCount < Jt
        },
        {
          code: "KeyK",
          keyLabel: "K",
          ...
          handler: () => {
            const e = this.curr.tick, t = this.curr.players[0];
            this.source.engine.command({
              apply_tick: e + 2,
              type: "ground_pass",
              tx: t ? t.x + 15 : 0,
    ...
    async handleMasterDebugToggle() {
      ...
      this.ui.playerCountInput && (this.ui.playerCountInput.value = e ? "1" : Jt.toString()), await this.restartPlayerSystem(), this.players.toggleMasterDebug(e), this.renderDebugInfoPanel();
    }
    setDriveMode(e) {
    ...
    getRequestedPlayerCount() {
      ...
      return Number.isNaN(t) || t <= 0 ? 1 : Math.min(t, Jt);
    }
    resolveUIElements() {
      return {
        playerCountInput: this.doc.getElementById("player-count"),
        applyPlayerCountBtn: this.doc.getElementById("apply-player-count"),
        modeIndicator: this.doc.getElementById("mode-indicator"),
        debugControls: this.doc.getElementById("debug-controls"),
        playerModelInput: this.doc.getElementById("player-model-url"),
        applyPlayerModelBtn: this.doc.getElementById("apply-player-model"),
        playerProfileSelect: this.doc.getElementById("player-profile-select"),
        debugInfoPanel: this.doc.getElementById("debug-info-panel")
      };
    }
  }
  const Rh = document.getElementById("app");
  if (!Rh) throw new Error('Missing root element with id="app"');
  const Ch = new v0(Rh);
  await Ch.init();
  Ch.start();
})();
